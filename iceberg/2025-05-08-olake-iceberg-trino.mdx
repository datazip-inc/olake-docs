...
- [**AWS Glue Data Catalog**](/iceberg/query-engine/athena): A centralised, managed metadata repository that can act as the iceberg catalog, making your S3 data discoverable
