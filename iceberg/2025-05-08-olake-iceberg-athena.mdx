...
- [**AWS Glue Data Catalog**](/iceberg/olake-iceberg-athena): A centralized, managed metadata repository that can act as the Iceberg catalog, making your S3 data discoverable
