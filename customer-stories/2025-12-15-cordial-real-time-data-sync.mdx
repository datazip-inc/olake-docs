...
image: /img/customers/cordial/cover-image-cordial.png
date: 2025-12-15
---
...
![Cordial Cover Image](/img/customers/cordial/cover-image-cordial.png)
...
<div style={{
  ...
  <p style={{
    ...
    "Managing a thousand different database connections wasn't hypothetical; it was the direction we were headed."
  </p>
  <div style={{
    display: 'flex',
    alignItems: 'center',
    ...
    <img 
      src="/img/customers/cordial/daniel-schaaff.jpeg" 
      alt="Daniel Schaaff"
      style={{
        width: '56px',
        height: '56px',
...
<div style={{
  ...
  <p style={{
    ...
    "Our replication systems work well for their intended use, but they're not designed to give AI and ML models a unified interface to our cross-cluster data."
  </p>
  <div style={{
    display: 'flex',
    alignItems: 'center',
    ...
    <img 
      src="/img/customers/cordial/justin-bradford.jpeg" 
      alt="Justin Bradford"
      style={{
        width: '56px',
        height: '56px',
