...
image: /img/customers/astrotalk/cover-image-astro.png
date: 2025-12-15
---
...
![Astro Talk Cover Image](/img/customers/astrotalk/cover-image-astro.png)
...
<div style={{
  ...
  <div style={{
    ...
    <img 
      src="/img/customers/astrotalk/anirudh.jpeg" 
      alt="Anirudh"
      style={{
        width: '56px',
        height: '56px',
...
<div style={{
  ...
  <p style={{
    ...
    "Support from OLake engineers has been amazing. Other companies say they have great support, but OLake's responsiveness easily stands out."
  </p>
  <div style={{
    display: 'flex',
    alignItems: 'center',
