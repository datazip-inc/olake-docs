...
const config = {
  ...
  tagline: 'A clean, high-performance alternative to one-off ETL and lock-in. Move Postgres/MySQL/MongoDB/Oracle data to Data Lakehouse that is Iceberg with being 5–500× faster.',
