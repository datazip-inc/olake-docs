...
- [Working with MongoDB](/docs/connectors/mongodb/?config-type=olake-cli#configuration)  
- [Working with MySQL](/docs/connectors/mysql/?config-type=olake-cli#configuration)  
- [Working with Oracle](/docs/connectors/oracle/?config-type=olake-cli#configuration)  
- [Working with Postgres](/docs/connectors/postgres/?config-type=olake-cli#configuration)
- [Working with S3](/docs/connectors/s3/?config-type=olake-cli#configuration)  
- [Working with DB2](/docs/connectors/db2/?config-type=olake-cli#configuration)  
- [Working with MSSQL](/docs/connectors/mssql/?config-type=olake-cli#configuration)
- [Working with Kafka](/docs/connectors/kafka/?config-type=olake-cli#configuration)      
...
- [Working with AWS S3](/docs/writers/parquet/config?S3=OLake-CLI#configuration)  
- [Working with Iceberg Glue Catalog](/docs/writers/iceberg/catalog/glue?tab=glue-cli#configuration)  
- [Working with Iceberg Hive Catalog](/docs/writers/iceberg/catalog/hive?tab=hive-cli#configuration)  
- [Working with Iceberg JDBC Catalog](/docs/writers/iceberg/catalog/jdbc?tab=jdbc-cli#configuration)  
- [Working with Iceberg REST Catalog](/docs/writers/iceberg/catalog/rest?rest-catalog=generic&tab=rest-cli#configuration)
- [Working with Iceberg Lakekeeper Catalog](/docs/writers/iceberg/catalog/rest?rest-catalog=lakekeeper&tab=lakekeeper-cli#configuration-1)
- [Working with Iceberg Nessie Catalog](/docs/writers/iceberg/catalog/rest?rest-catalog=nessie&tab=nessie-cli#configuration-2)
- [Working with Iceberg S3 Tables Catalog](/docs/writers/iceberg/catalog/rest?rest-catalog=s3-tables&tab=s3tables-cli#configuration-3)
- [Working with Iceberg Unity Catalog](/docs/writers/iceberg/catalog/rest?rest-catalog=unity&tab=unity-cli#configuration-4)
- [Working with Iceberg Polaris Catalog](/docs/writers/iceberg/catalog/rest?rest-catalog=polaris&tab=polaris-cli#configuration-5)
- [Working with Iceberg BigLake Catalog](/docs/writers/iceberg/catalog/rest?rest-catalog=biglake&tab=biglake-cli#configuration-6)
...
- To discover the available streams from the source, run the following command:
  ...
  <details>
    <summary><code>--config</code> <span style={{padding: "2px 8px", backgroundColor: "#ff4444", color: "white", borderRadius: "4px", fontSize: "12px", marginLeft: "8px"}}>required</span></summary>
    
  <FlagDetail flag="config" mode="docker" command="discover" />

  </details>

  <details>
    <summary><code>--streams</code> <span style={{padding: "2px 8px", backgroundColor: "#888888", color: "white", borderRadius: "4px", fontSize: "12px", marginLeft: "8px"}}>optional</span></summary>
    
  <FlagDetail flag="streams" mode="docker" command="discover" />

  </details>

  <details>
    <summary><code>--destination-database-prefix</code> <span style={{padding: "2px 8px", backgroundColor: "#888888", color: "white", borderRadius: "4px", fontSize: "12px", marginLeft: "8px"}}>optional</span></summary>
    
  <FlagDetail flag="destination-database-prefix" mode="docker" command="discover" />

  </details>

  <details>
    <summary><code>--timeout</code> <span style={{padding: "2px 8px", backgroundColor: "#888888", color: "white", borderRadius: "4px", fontSize: "12px", marginLeft: "8px"}}>optional</span></summary>
    
  <FlagDetail flag="timeout" mode="docker" command="discover" />

  </details>

  <details>
    <summary><code>--max-discover-threads</code> <span style={{padding: "2px 8px", backgroundColor: "#888888", color: "white", borderRadius: "4px", fontSize: "12px", marginLeft: "8px"}}>optional</span></summary>
    
  <FlagDetail flag="max-discover-threads" mode="docker" command="discover" />

  </details>


  <details>
    <summary><code>--difference</code> <span style={{padding: "2px 8px", backgroundColor: "#888888", color: "white", borderRadius: "4px", fontSize: "12px", marginLeft: "8px"}}>optional</span></summary>
    
  <FlagDetail flag="difference" mode="docker" command="discover" />
...
| **`update_type`**     | string        | `"eq"` or `"pos"` or `"dv"`                                                                    | Specifies the format in which delete files are written during sync. <br/> `"eq"` writes equality delete files. <br/> `"pos"` writes positional delete files. <br/> `"dv"` writes deletion vector files.                                                                                |
...
This command is executed when a sync needs to be run in Full Refresh mode or when running a sync for the first time (i.e., before a state file has been created).
    ...
    <FlagDetail flag="config" mode="docker" command="sync" />

    </details>

    <details>
      <summary><code>--streams</code> <span style={{padding: "2px 8px", backgroundColor: "#ff4444", color: "white", borderRadius: "4px", fontSize: "12px", marginLeft: "8px"}}>required</span></summary>
      
    <FlagDetail flag="streams" mode="docker" command="sync" />

    </details>

    <details>
      <summary><code>--destination</code> <span style={{padding: "2px 8px", backgroundColor: "#ff4444", color: "white", borderRadius: "4px", fontSize: "12px", marginLeft: "8px"}}>required</span></summary>
      
    <FlagDetail flag="destination" mode="docker" command="sync" />

    </details>

    <details>
      <summary><code>--state</code> <span style={{padding: "2px 8px", backgroundColor: "#888888", color: "white", borderRadius: "4px", fontSize: "12px", marginLeft: "8px"}}>optional</span></summary>
      
    <FlagDetail flag="state" mode="docker" command="sync" />

    </details>

    <details>
      <summary><code>--discover-schema</code> <span style={{padding: "2px 8px", backgroundColor: "#888888", color: "white", borderRadius: "4px", fontSize: "12px", marginLeft: "8px"}}>optional</span></summary>
      
    <FlagDetail flag="discover-schema" mode="docker" command="sync" />
...
![VS Code window displaying OLake Go logs for MongoDB sync and schema production events](/img/docs/features/olake-logs.webp)
...
:::info
For a complete reference of all available commands and their flags (used to configure stream-level properties) see the [Commands and Flags](/docs/community/commands-and-flags) guide.
:::
