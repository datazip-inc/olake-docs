...
In the same directory where the OLake Go [docker-compose-v1.yml](https://raw.githubusercontent.com/datazip-inc/olake-ui/refs/heads/master/docker-compose-v1.yml) file is located, a new file named `.env` must be created.
