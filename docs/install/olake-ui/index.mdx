...
:::warning
Positional deletes and the index DB environment variables above require the versions mentioned below. Upgrade every listed service, missing an update on single component can cause job failures:
