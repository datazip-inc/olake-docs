...
Configure the index database through environment variables on the `temporal-worker` service in your `docker-compose.yml` file only when you want **positional deletes or deletion vector** as the upsert type.
