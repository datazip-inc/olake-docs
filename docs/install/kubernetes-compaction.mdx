...
Compaction-related components provide Iceberg table maintenance and compaction in the platform. Documentation for Lite, Medium, and Full compaction is [here](https://olake.io/docs/iceberg-maintenance/compaction/overview/).
