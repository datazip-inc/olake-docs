...
With Fusion enabled, follow [Configure your first compaction](https://olake.io/docs/getting-started/configure-first-compaction) for step-by-step guidance on adding catalogs and scheduling Iceberg maintenance in the OLake UI.
