...
![OLake UI, Postgres, Temporal orchestrating OLake-Go ingestion, and Fusion performing maintenance against the data catalog](/img/docs/fusion-architecture.png)
