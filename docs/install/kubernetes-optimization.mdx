...
Optimization components provide Iceberg table compaction and optimization services. The documentation for optimization can be found [here](https://olake.io/docs/iceberg-maintenance/optimization/overview/).
