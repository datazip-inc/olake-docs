...
<Tabs queryString="setup-mode" groupId="olake-ui-k8s-setup-mode">
  <TabItem value="installation" label="Installation" default>
    ...
    OLake will run on mixed capacity, but scheduling the components below on stable, non-preemptible (on-demand) nodes lowers the chance of spot or preemptible churn interrupting core services and data replication jobs:
