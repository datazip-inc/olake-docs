...
description: OLake Installation via Kubernetes using Helm
sidebar_position: 2
---

# OLake Kubernetes Installation with Helm

This guide details the process for deploying OLake on Kubernetes using the official Helm chart. 
...
- **Temporal UI**(Optional): Web interface for monitoring workflows and debugging
