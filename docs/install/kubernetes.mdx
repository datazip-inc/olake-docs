...
- **Chart-provided NFS server (optional)**: If the chart-provided `nfs-server` is used, it should be scheduled on an on-demand node; any outage will disrupt service
