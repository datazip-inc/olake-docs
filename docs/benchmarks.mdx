...
| ------------------ | ----------: | ----------------------: | -------------------- |
| **OLake**          |  **4.01 B** |          **2,35,411 RPS** | –                    |
| Fivetran           |      4.01 B |              46,395 RPS | **5.1 × slower** |
| Debezium (memiiso) |      1.28 B |              14,839 RPS | **15.9 × slower**     |
| Estuary            |      0.34 B |               3,982 RPS | **59.1 × slower**¹   |
| Airbyte Cloud          |      12.7 M |                 457 RPS | **515.1 × slower**     |
