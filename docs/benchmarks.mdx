...
| Tool                                               | Rows Synced | Throughput (rows / sec) | Relative to OLake  |
|----------------------------------------------------|-------------|-------------------------|--------------------|
| **OLake** <br/><span className='text-xs text-slate-500'>(as of 5th Dec 2025)</span>         | **1.01 B**  | **2,09,065 MPS**        | –                  |
| Flink <br/><span className='text-xs text-slate-500'>(as of 5th Dec 2025)</span>           | 1.01 B      | 2,56,410 MPS              | **1.23 × faster**   |
...
| Flink  | Batch Load  | $3.62 `(D64ls v6 running for 1 hour)` | $4.42 `(3× m7g.4xlarge running for 1 hour)` | **$8.04** | 1.01 B |
