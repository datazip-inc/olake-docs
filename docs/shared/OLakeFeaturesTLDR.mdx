...
4. **Query engines** – Any Iceberg v2-aware tool (Trino, Spark, Flink, Snowflake, etc.) can query OLake outputs immediately. See [here](/docs/getting-started/setup-olake) for more
