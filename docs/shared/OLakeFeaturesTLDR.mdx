...
6. **[Schema evolution & datatype changes](/docs/features?tab=schema)** – Column adds, drops and type promotions are auto-detected and written per Iceberg v2 spec, so pipelines never break.
