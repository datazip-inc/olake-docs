---
title: GCP Hive Iceberg Writer Configuration
description: Configuration for using GCP Dataproc Metastore with Hive catalog and GCS storage
---
...
#### GCP-based OLake Destination Config
...
#### GCP Dataproc
![GCP Dataproc Metastore](/img/docs/iceberg/hive-gcp-dataproc.png)
