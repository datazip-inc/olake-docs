...
const NESSIE_REST_CATALOG_URI_DESCRIPTION = (
  <>
...
const FIELDS = [
  {
    ...
    description: NESSIE_REST_CATALOG_URI_DESCRIPTION,
  },
  {
    id: 'catalog-name',
    authTypes: AUTH_COMMON,
...
export default function NessieIcebergWriterUIConfigDetails({ authType }) {
