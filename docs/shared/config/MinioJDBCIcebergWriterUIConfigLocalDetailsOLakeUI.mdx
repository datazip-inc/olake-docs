...
| **AWS Access Key**  | `admin`                                        | S3 access key ID for authentication. Use MinIO credentials for local development.                                                       |
| **AWS Region**        | `us-east-1`                        | AWS region identifier for S3 bucket location. Required even for non-AWS S3-compatible services.                                                                     |
| **AWS Secret Key**  | `password`                                     | S3 secret access key for authentication. Use MinIO credentials for local development.                                                    |
