...
| rest_catalog_url | `http://<REST_HOSTNAME>:8181`            | Specifies the endpoint URL for the REST catalog service that the writer will connect to.                              |
...
| aws_access_key   | `<S3_ACCESS_KEY>`                            | AWS access key.                                                                      |
| aws_secret_key   | `<S3_SECRET_KEY>`                         | AWS secret key.                                                                   |
