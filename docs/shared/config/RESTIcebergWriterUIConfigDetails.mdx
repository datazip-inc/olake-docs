...
| **S3 Endpoint**      | `http://<S3_ENDPOINT>:9000`   | S3 API endpoint for writing Iceberg data files. Optional for AWS S3 but required for S3-compatible storage like MinIO.                                                                                          |
