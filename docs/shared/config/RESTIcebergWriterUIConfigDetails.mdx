...
|------------------|------------------------------------------|-----------------------------------------------------------------------------------------------------------------------|
| REST Catalog URL | `http://<REST_HOSTNAME>:8181`         | Specifies the endpoint URL for the REST catalog service that the writer will connect to.                              |
...
| AWS Access Key   | `<S3_ACCESS_KEY>`                                    | AWS access key.                                                                      |
| AWS Secret Key   | `<S3_SECRET_KEY>`                         | AWS secret key.                                                                   |
