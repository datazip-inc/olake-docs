...
- **Column:** `_cdc_resume_token`
    ...
    - **Example:** `{"_data": "8267E4B5F7000000022B022C0100296E5A1004F8EAF9F6C4D5E5E7C2E6964664006467E4B5F7"}`
...
- **Columns:** `_cdc_start_lsn`, `_cdc_seqval`
    ...
    - **Example:** `_cdc_start_lsn = "0x00000026000001230004"`, `_cdc_seqval = "0x0000000F00000001"`
