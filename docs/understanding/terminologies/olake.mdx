...
- **Column Selection:**
  ...
  - OLake Go-generated columns **cannot be deselected**. For more information about these columns, refer to [OLake Go-Generated Columns](/docs/understanding/terminologies/olake/#olake-generated-columns).
