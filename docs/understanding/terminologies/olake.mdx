...
:::info CDC/Incremental Filter Behavior
  - From **OLake connector v0.6.0** and **OLake UI v0.4.1** onwards, data filter is now available for **CDC and Incremental sync** as well, and the filter configured during **Full Refresh** will be applied during subsequent **CDC and Incremental** syncs.
