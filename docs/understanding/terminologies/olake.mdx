...
- **Data Filter (Column and Values):** Only columns that are common across all selected streams and have matching data types are available for data filter configuration.
