...
:::info CDC/Incremental Filter Behavior
  - From **OLake connector v0.6.0** onward, data filter is now available for **CDC and Incremental sync** as well, and filter that is configured during **Full Refresh** will be applied during subsequent **CDC and Incremental** syncs.
