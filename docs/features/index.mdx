...
- [**Iceberg partitioning**](/iceberg/hive-partitioning-vs-iceberg-partitioning) → Metadata-driven, no need for directory-based partitioning; enables efficient pruning and schema evolution.
