...
Before continuing with the steps below, you must thoroughly review the [**Commands and Flags**](/docs/community/commands-and-flags) guide.  
This is required to understand the OLake CLI commands, flags, and the required file inputs used throughout this walkthrough.
:::
