...
#### Optional Flags:
- [**`--destination-database-prefix`**](/docs/community/commands-and-flags#7-destination-database-prefix) → Adds a custom prefix to the destination database name.<br/>
    example: 
    ```
...
- Adds a custom prefix to the database name created in the destination.<br/>
    ...
    ```
    ./build.sh driver-[SOURCE-TYPE] [COMMAND] --destination-database-prefix olake
    ```
