...
### 12. Max discover threads
```
./build.sh driver-[SOURCE-TYPE] discover --max-discover-threads [NUMBER_OF_THREADS]
```
**Description:** 
- Applies only to the discover command.
- Sets the maximum number of parallel threads used for discovering tables in the database.
