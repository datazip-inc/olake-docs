...
- **Run Metrics** – available after an optimization run finishes successfully.
...
Run Metrics are shown after an optimization run finishes successfully and are accessed from the **Runs** page via the **View Metrics** action for that run.
