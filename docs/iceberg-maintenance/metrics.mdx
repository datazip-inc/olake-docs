...
| Input equality delete files    | Count of input equality delete files(Formula: Input equality delete files * No.of sub-tasks) |
| Input equality delete size     | Total size of input equality delete files |
| Input position delete files    | Count of input position delete files(Formula: Input position delete files * No.of sub-tasks) |
