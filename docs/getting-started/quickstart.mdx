...
# How to get started with OLake Go
This QuickStart guide helps get started with [OLake UI](/docs/install/olake-ui/), a web-based interface designed to simplify the management of OLake Go jobs, sources, destinations, and configurations. 
