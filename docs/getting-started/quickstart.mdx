...
<Tabs>
  <TabItem value="new" label="New (Recommended)" default>
    ```bash
    curl -sSL https://raw.githubusercontent.com/datazip-inc/olake-ui/master/docker-compose.yml | docker compose -f - up -d
    ```
    *This setup uses Postgres for both metadata and Temporal visibility.*
  </TabItem>
  <TabItem value="legacy" label="Legacy (ES + Postgres)">
    ```bash
    curl -sSL https://raw.githubusercontent.com/datazip-inc/olake-ui/master/docker-compose-legacy.yml | docker compose -f - up -d
    ```
...
<Tabs>
  <TabItem value="new" label="New Setup" default>
    ```bash
    curl -sSL https://raw.githubusercontent.com/datazip-inc/olake-ui/master/docker-compose.yml | docker compose -f - down && \
    curl -sSL https://raw.githubusercontent.com/datazip-inc/olake-ui/master/docker-compose.yml | docker compose -f - up -d
    ```
  </TabItem>
  <TabItem value="legacy" label="Legacy Setup">
    ```bash
    curl -sSL https://raw.githubusercontent.com/datazip-inc/olake-ui/master/docker-compose-legacy.yml | docker compose -f - down && \
    curl -sSL https://raw.githubusercontent.com/datazip-inc/olake-ui/master/docker-compose-legacy.yml | docker compose -f - up -d
    ```
  </TabItem>
</Tabs>