...
:::note
This does not delete the job configurations and docker volumes. To delete them run above command with [`-v` flag](https://docs.docker.com/reference/cli/docker/compose/down/).
:::