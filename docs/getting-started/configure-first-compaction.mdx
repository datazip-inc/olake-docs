...
- **Existing users (Docker):** If you are already using OLake Go for Ingestion, follow the [upgrade guide](/docs/install/olake-ui/#updating-olake-ui-version) to access the Maintenance module.
- **Existing users (Helm / Kubernetes):** If you are running OLake Go on Kubernetes, follow the [chart upgrade guide](/docs/install/kubernetes-compaction/#upgrading-chart-version) to access the Maintenance module.
