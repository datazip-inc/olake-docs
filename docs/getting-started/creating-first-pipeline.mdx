...
<div>
  ![Selecting new source](../../static/img/docs/getting-started/create-your-first-job/new-source.webp)
</div>
...
<div className='mx-auto w-full lg:w-[80%]'>
  ![Job source
  creation](../../static/img/docs/getting-started/create-your-first-job/dest-travel.webp)
</div>
