...
![Olake create destination](../../static/img/docs/getting-started/create-your-first-job/create-dest.png)
...
Once you have selected the source and destination, click on the **Next** button to proceed to the next step.
