...
- For the ingestion mode, select **Upsert** and choose **Equality Deletes**/**Position Deletes** as the delete format. See [Upsert](/docs/understanding/terminologies/olake/#upsert) for what Upsert does and how the delete formats differ.
