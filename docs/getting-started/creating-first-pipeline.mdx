...
- For the ingestion mode, select **Upsert** and choose **Equality Deletes**/**Position Deletes**/**Deletion Vectors** as the delete format (upsert type). See [Upsert](/docs/understanding/terminologies/olake/#upsert) for what Upsert does and how the delete formats differ.
    :::important Delete Format (Upsert Type) Changes
