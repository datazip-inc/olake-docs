...
In **Advanced Settings**, you can optionally select a **Target Query Engine**. This filters the delete format options shown in the Streams page to only those supported by your chosen query engine.
