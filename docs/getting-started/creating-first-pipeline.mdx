...
In our case, the `employees` stream has a string column named `company`, which we will partition by **company name**. Learn more about partitioning in the [Partitioning Guide](/docs/writers/parquet/partitioning).
