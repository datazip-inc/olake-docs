...
For other supported sources and their configurations, check out the [Supported Connectors](#supported-connectors) section.
...
For other supported destinations and their configurations, check out the [Supported Connectors](#supported-connectors) section.
...
Here, you can choose your preferred [sync mode](/docs/understanding/olake-terminologies/stream-properties#sync-modes) and configure [partitioning](/docs/writers/parquet/partitioning) as well as other stream-level settings here.
...
To learn more about sync modes, refer to our [Sync Modes Guide](/docs/understanding/olake-terminologies/stream-properties#sync-modes) in the documentation.
...
For connector specific configuration or troubleshooting, check out the following guides:

**Sources**
| Source   |                                                    |                                                              |
|----------|----------------------------------------------------|--------------------------------------------------------------|
| MySQL    | [Config](/docs/connectors/mysql#configurations)    | [Troubleshooting](/docs/connectors/mysql#troubleshooting)    |
| Postgres | [Config](/docs/connectors/postgres#configurations) | [Troubleshooting](/docs/connectors/postgres#troubleshooting) |
| MongoDB  | [Config](/docs/connectors/mongodb#configurations)  | [Troubleshooting](/docs/connectors/mongodb#troubleshooting)  |
| Oracle   | [Config](/docs/connectors/oracle#configurations)   | [Troubleshooting](/docs/connectors/oracle#troubleshooting)   |
...
- **Parquet S3**
    | Destination      | Config                                                               | Troubleshooting                                                                               |
    |------------------|----------------------------------------------------------------------|-----------------------------------------------------------------------------------------------|
    | Parquet          | [Config](/docs/writers/parquet/config)                               | [Troubleshooting](/docs/writers/parquet/local?view=troubleshooting)                           |

- **Iceberg**
  | Catalog          | Config                                                                              | Troubleshooting                                                                               |
  |------------------|-------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------|
  | AWS Glue Catalog | [Config](/docs/writers/iceberg/catalog/glue#configurations)                         | [Troubleshooting](/docs/writers/iceberg/catalog/glue#troubleshooting)                         |
  | Hive Catalog     | [Config](/docs/writers/iceberg/catalog/hive#configurations)                         | [Troubleshooting](/docs/writers/iceberg/catalog/hive#troubleshooting)                         |
  | JDBC Catalog     | [Config](/docs/writers/iceberg/catalog/jdbc#configurations)                         | [Troubleshooting](/docs/writers/iceberg/catalog/jdbc#troubleshooting)                         |
  | REST Catalog     | [Config](/docs/writers/iceberg/catalog/rest/rest-catalog=generic#configurations)    | [Troubleshooting](/docs/writers/iceberg/catalog/rest?rest-catalog=generic#troubleshooting)    |
  | Nessie Catalog   | [Config](/docs/writers/iceberg/catalog/rest?rest-catalog=nessie#configurations)     | [Troubleshooting](/docs/writers/iceberg/catalog/rest?rest-catalog=nessie#troubleshooting)     |
  | LakeKeeper       | [Config](/docs/writers/iceberg/catalog/rest?rest-catalog=lakekeeper#configurations) | [Troubleshooting](/docs/writers/iceberg/catalog/rest?rest-catalog=lakekeeper#troubleshooting) |
  | S3 Tables        | [Config](/docs/writers/iceberg/catalog/rest?rest-catalog=s3-tables#configurations)  | [Troubleshooting](/docs/writers/iceberg/catalog/rest?rest-catalog=s3-tables#troubleshooting)  |
  | Polaris          | [Config](/docs/writers/iceberg/catalog/rest?rest-catalog=polaris#configurations)    | [Troubleshooting](/docs/writers/iceberg/catalog/rest?rest-catalog=polaris#troubleshooting)    |
  | Unity            | [Config](/docs/writers/iceberg/catalog/rest?rest-catalog=unity#configurations)      | [Troubleshooting](/docs/writers/iceberg/catalog/rest?rest-catalog=unity#troubleshooting)      |
