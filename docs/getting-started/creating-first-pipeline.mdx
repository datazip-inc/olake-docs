...
Follow the [Quickstart Setup Guide](/docs/getting-started/quickstart) to ensure the [OLake UI](/docs/getting-started/quickstart) is running at [localhost:8000](http://localhost:8000)
...
For this demonstration, we'll use [**Postgres**](/docs/connectors/postgres) as the source and [**Apache Iceberg**](/iceberg) with Glue catalog as the destination.
