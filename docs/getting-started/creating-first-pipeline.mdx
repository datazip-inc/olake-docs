...
We have introduced support for filtering columns with special characters in CLI. Column names with underscores work normally without any escape. For column names with other special characters, use the following format:
```
