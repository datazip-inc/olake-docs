...
The instructions below apply once you are on the **Tables** page.

If you clicked **View Tables** in the **Catalog Added Successfully** modal after adding the catalog, you are already on **Tables**—skip to selecting the catalog and database below.

If you did **not** use **View Tables** (for example you chose **View Catalogs** or closed the modal), open the **Maintenance** dropdown in the sidebar and select **Tables**.
