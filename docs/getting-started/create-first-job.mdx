...
With OLake, you can configure a [source](/docs/connectors/overview), set up a [destination](/docs/writers/overview), and create a job to move data between them either through the **OLake UI** or the **OLake CLI** (command-line).
...
<TabItem value="olake-ui" label="OLake UI" default>
    ...
    This tutorial is written in a step-by-step, blog-style format. If you prefer video, check out our [video walkthrough](#create-your-first-job-video-tutorial).
