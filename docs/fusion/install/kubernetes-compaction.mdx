...
:::info
For OLake Go related configuration options that are not covered in this page, see the [OLake Go Kubernetes installation guide](/docs/install/kubernetes/#configuration-options).
:::
