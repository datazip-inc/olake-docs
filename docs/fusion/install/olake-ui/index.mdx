...
<TabItem value="olake-go" label="OLake Go" default>

The OLake Go stack can be completely reset with:
...
<TabItem value="olake-fusion" label="OLake Fusion">

The OLake Fusion stack can be completely reset with:
