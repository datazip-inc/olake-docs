...
1. After logging in to the OlakeUI, select the `Sources` tab from the left sidebar.
2. Click **`Create Source`** on the top right corner.  
3. Select **Oracle** from the connector dropdown
...
- In case of connection failure refer the [Troubleshooting section](#troubleshooting).
...
- In case of connection failure refer the [Troubleshooting section](#troubleshooting-1).
...
|---|---|---|
|27 April 2025 | [0.1.11](https://github.com/datazip-inc/olake/releases/tag/v0.1.11) | override default timeout in Discover |