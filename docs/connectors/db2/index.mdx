...
| jdbc_url_params                 | Extra [JDBC URL parameters](https://www.ibm.com/docs/en/db2/11.5.x?topic=information-properties-data-server-driver-jdbc-sqlj) for fine-tuning the connection.                                                                   | `{"connectTimeout":"20"}`                                                                                | Object |
