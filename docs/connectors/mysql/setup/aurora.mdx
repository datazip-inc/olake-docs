...
![mysql-aurora-pg-1](/static/img/docs/cdc/mysql/mysql-aurora-pg-1.png)
...
![mysql-aurora-pg-2](/static/img/docs/cdc/mysql/mysql-aurora-pg-2.png)

   - Save the parameter group changes.

![mysql-aurora-pg-3](/static/img/docs/cdc/mysql/mysql-aurora-pg-3.png)


## Associate this new cluster parameter group with your Aurora cluster
In the RDS console, modify the Aurora cluster to use the new cluster parameter group.
...
![mysql-aurora-pg-4](/static/img/docs/cdc/mysql/mysql-aurora-pg-4.png)
