...
Below is an example:
    ...
    | **streams[].stream.available_cursor_fields** | Available Cursor Fields | Fields usable as cursors for incremental syncs.                     | Array of Strings  | Required                  |
