...
## Prerequisites
    ...
    - [Binary Logging](/blog/binlogs) (Required):
      ...
      - Optional (required only for CDC timestamp microsecond precision):
        - enforce_gtid_consistency=ON (must be set before `gtid_mode`)
        - gtid_mode=ON
...
| tls_skip_verify                      | Indicates whether to skip TLS certificate verification.                                                                                                             | `false`                                                                                                | BOOLEAN    |
