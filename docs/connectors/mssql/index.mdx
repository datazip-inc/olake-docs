...
| ----------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- | ------ |
| DB2 Host `required`                 | Hostname or IP address of the MSSQL database server.                                                                                                                          | `MSSQL LUW-host`                                                                                           | String |
| DB2 Port `required`                 | TCP port on which the MSSQL listener is accepting connections.                                                                                                                | `1433`                                                                                                  | Integer |
