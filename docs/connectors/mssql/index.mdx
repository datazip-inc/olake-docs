...
| Manage Capture Instance             | When enabled, it automatically creates and manages CDC capture instances on schema evolution. | `enabled`                                                                                                | 
...
| Manage Capture Instance             | When enabled, it automatically creates and manages CDC capture instances on schema evolution.  | `enabled`                                                                                                | Boolean | 
