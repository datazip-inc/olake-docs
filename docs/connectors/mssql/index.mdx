...
This is optional and not mandatory. If you want faster chunking for tables without primary keys, you can grant view table state permission.
...
### 1. High CPU usage for tables without a primary key

Jobs syncing tables without a primary key can consume more CPU because parallel chunking is less efficient without a primary key.
