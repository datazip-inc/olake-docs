...
:::info
Vaibhav UI is live (beta)! You can now use the UI to configure your MongoDB source, discover streams, and sync data. Check it out at [OLake UI](../../getting-started/olake-ui) regarding how to setup using Docker Compose and running it locally.
