...
| IAM Authentication                                     | Turn on to use IAM credentials stored in host machine instead of password based authentication | `off`                                                                   |
...
| `use_iam`                                           | Use IAM credentials stored in host machine instead of password based authentication    | `false`                                          | BOOLEAN  |
