...
### 1. Create MongoDB Source Setup via Olake UI
...
### 2. Edit MongoDB Source Setup via Olake UI
...
![Olake UI MongoDB Edit Setup](/img/connectors/mongodb/mongodb-ui-edit.png)

### 3. Jobs associated with MongoDB Source
...
![Olake UI MongoDB Job Setup](/img/connectors/mongodb/mongodb-ui-jobs.png)

### 4. Delete MongoDB Source Setup in Olake UI
...
![Olake UI MongoDB Edit Setup](/img/connectors/mongodb/mongodb-ui-delete-1.png)

4. A confirmation dialog will appear asking you to confirm the deletion.
5. Click on **Delete** to confirm the deletion.

![Olake UI MongoDB Edit Setup](/img/connectors/mongodb/mongodb-ui-delete-2.png)
---
