...
![postgres-rds-pg-1](/static/img/docs/cdc/postgres/postgres-rds-pg-1.png)
...
![postgres-rds-pg-2](/static/img/docs/cdc/postgres/postgres-rds-pg-2.png)
...
4. **Create a Logical Replication Slot:** You can let the CDC application create the slot, but to test or manually create one:
   ```sql
   SELECT * 
