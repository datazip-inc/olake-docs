...
- **No Changes Captured:** If the slot exists and the connector is running but no changes are coming through:
  ...
  - Make sure your CDC tool is using the wal2json plugin (and not expecting `pgoutput`). 
