...
| JDBC URL Parameters                 | Extra [JDBC URL parameters](https://jdbc.postgresql.org/documentation/use/) for fine-tuning the connection.                                                                   | `{"connect_timeout":"20"}`                                                                                |
...
| jdbc_url_params                      | Extra [JDBC URL parameters](https://jdbc.postgresql.org/documentation/use/) for fine-tuning the connection.                                                         | `{"connect_timeout":"20"}`                                                                              | OBJECT                                                           |
