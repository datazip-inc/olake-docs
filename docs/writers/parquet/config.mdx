...
:::tip
Before proceeding with the S3 Parquet destination, we recommend reviewing the [Getting Started](/docs/getting-started/quickstart) and [Installation](/docs/install/olake-ui) sections.
:::
...
Steps to get started with S3 Destination using OLake UI. Assuming OLake UI is running.
