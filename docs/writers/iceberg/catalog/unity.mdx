...
| **Disable Identifier Fields** | `true` | Required for Unity Catalog managed Iceberg tables that don't support equality delete-based updates. Must be enabled. |
...
<div style={{ textAlign: "center" }}>
  <img src="/img/docs/iceberg/catalog/unity/olake-unity-dest.png" 
       alt="Olake Partition output"
       style={{ width: "100%", maxWidth: "1200px", border: "2px solid #ccc"}} />
</div>
...
- **Unity Catalog Compatibility**: The `no_identifier_fields: true (OLake CLI)` or `Disable Identifier Fields: true (OLake UI)` setting is crucial for Unity Catalog managed Iceberg tables as they don't support equality delete-based updates
...
For more general guidance on Iceberg integration, refer to the [Iceberg writer documentation](/docs/writers/iceberg/catalog/rest?rest-catalog=generic). 