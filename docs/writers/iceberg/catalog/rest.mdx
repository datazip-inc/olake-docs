      ...
      **Permissions**:
      ...
      <Tabs queryString="tab">
        <TabItem value="rest-ui" label="OLake UI" default>
          ...
          <div className='flex justify-center w-2/3 mx-auto'>
          ![REST endpoint config form with required fields for Iceberg database connection.](/img/docs/iceberg/catalog/rest/rest_lakekeeper_dest_config.png)
        </div>
    ...
    <Tabs queryString="tab">
      ...
      <TabItem value="nessie-ui" label="OLake UI" default>
        ...
        **Nessie Configuration Parameters:**
        ...
        |----------------------|-----------------------------------------|----------------------------------------------------------------------------------------------------------------|
        | **catalog_type**     | `rest`                                  | Defines the catalog type used by the writer. "rest" means the writer interacts with a RESTful catalog service. |
        | **rest_catalog_url** | `http://<YOUR_MACHINE_IP>:19120/iceberg/` | Specifies the endpoint URL for the Nessie REST catalog service. <br/>**Linux:** Use machine's private IP (e.g., `http://192.168.1.100:19120/iceberg/`) <br/>**macOS:** Use `http://host.docker.internal:19120/iceberg/` |
        ...
        | **s3_endpoint**      | `http://<YOUR_MACHINE_IP>:9000/`        | Endpoint for the MinIO S3-compatible service. <br/>**Linux:** Use machine's private IP (e.g., `http://192.168.1.100:9000/`) <br/>**macOS:** Use `http://host.docker.internal:9000/` |
