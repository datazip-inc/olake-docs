...
import HorizonIcebergWriterUIConfigDetails from '@site/docs/shared/config/HorizonIcebergWriterUIConfigDetails.jsx';
import HorizonIcebergWriterCLIConfigDetails from '@site/docs/shared/config/HorizonIcebergWriterCLIConfigDetails.jsx';
        ...
        <TabItem value="none" label="None" default>
          <Tabs queryString="tab">
            ...
            <br/>
              ...
              <div className='flex justify-center w-2/3 mx-auto'>
              ![REST endpoint config form with required fields for Iceberg database connection.](/img/docs/iceberg/catalog/rest/rest_lakekeeper_none_ui.webp)
            </div>
        ...
        <TabItem value="token" label="Token">
          <Tabs queryString="tab">
            ...
            <br/>
              ...
              <div className='flex justify-center w-2/3 mx-auto'>
              ![REST endpoint config form with required fields for Iceberg database connection.](/img/docs/iceberg/catalog/rest/rest_lakekeeper_token_ui.webp)
            </div>
        ...
        <TabItem value="oauth2" label="OAuth2">
          <Tabs queryString="tab">
            ...
            <br/>
              ...
              <div className='flex justify-center w-2/3 mx-auto'>
              ![REST endpoint config form with required fields for Iceberg database connection.](/img/docs/iceberg/catalog/rest/rest_lakekeeper_oauth_ui.webp)
            </div>
      ...
      <TabItem value="none" label="None" default>
        <Tabs queryString="tab">
          ...
          <br/>
            ...
            <div className='flex justify-center w-2/3 mx-auto'>
              ![REST endpoint config form with required fields for Iceberg database connection.](/img/docs/iceberg/catalog/rest/rest_nessie_none_ui.webp)
            </div>
      ...
      <TabItem value="token" label="Token">
        ...
        <Tabs queryString="tab">
          ...
          <br/>
            ...
            <div className='flex justify-center w-2/3 mx-auto'>
              ![REST endpoint config form with required fields for Iceberg database connection.](/img/docs/iceberg/catalog/rest/rest_nessie_token_ui.webp)
            </div>
      ...
      <TabItem value="oauth2" label="OAuth2">
        ...
        <Tabs queryString="tab">
          ...
          <TabItem value="nessie-ui" label="OLake UI" default>
            ...
            <div className='flex justify-center w-2/3 mx-auto'>
              ![REST endpoint config form with required fields for Iceberg database connection.](/img/docs/iceberg/catalog/rest/rest_nessie_oauth_ui.webp)
            </div>
...
<Tabs queryString="tab">
  ...
  <br/>
      ...
      <div className='flex justify-center w-2/3 mx-auto'>
        ![Iceberg REST config form with required fields for Catalog URI, S3 Path, database, AWS credentials, and region](/img/docs/iceberg/catalog/rest/rest_s3_tables_ui.webp)
      </div>
      ...
      **S3 Tables Configuration Parameters:**
      ...
      | **Authentication Type** <br/> `required` | `sigv4` | Authentication method OLake Go uses for S3 Tables REST catalog requests. S3 Tables only supports AWS Signature Version 4 (SigV4) authentication. |
  ...
  {/* REST – Unity */}
    ...
    <Tabs queryString="rest-auth-type" groupId="unity-rest-auth">
      <TabItem value="personal-access-token" label="Personal Access Token" default>
        ...
        <div className='flex justify-center w-2/3 mx-auto'>
        ![REST endpoint config form with required fields for Iceberg database connection.](/img/docs/iceberg/catalog/rest/rest_unity_pat_ui.webp)
        </div>
      ...
      <TabItem value="oauth2-m2m" label="OAuth2 M2M">
        ...
        <div className='flex justify-center w-2/3 mx-auto'>
        ![REST endpoint config form with required fields for Iceberg database connection.](/img/docs/iceberg/catalog/rest/rest_unity_m2m_ui.webp)
        </div>
      ...
      <TabItem value="oauth2-u2m" label="OAuth2 U2M">
        ...
        <div className='flex justify-center w-2/3 mx-auto'>
        ![REST endpoint config form with required fields for Iceberg database connection.](/img/docs/iceberg/catalog/rest/rest_unity_u2m_ui.webp)
        </div>
      ...
      <TabItem value="token-federation" label="Token Federation">
        ...
        <div className='flex justify-center w-2/3 mx-auto'>
        ![REST endpoint config form with required fields for Iceberg database connection.](/img/docs/iceberg/catalog/rest/rest_unity_tokenfed_ui.webp)
        </div> 
    ...
    4. **Network Access**: Verify your OLake Go instance can reach the Databricks workspace URL
    ...
    **Required permissions**:
    ...
    <Tabs queryString="rest-auth-type" groupId="polaris-rest-auth">
      ...
      <br/>
        ...
        <div className='flex justify-center w-2/3 mx-auto'>
          ![REST endpoint config form with fields for REST, database, S3, and AWS credentials](/img/docs/iceberg/catalog/rest/rest_polaris_token_ui.webp)
        </div>
      ...
      <br/>
        ...
        <div className='flex justify-center w-2/3 mx-auto'>
          ![REST endpoint config form with fields for REST, database, S3, and AWS credentials](/img/docs/iceberg/catalog/rest/rest_polaris_oauth_ui.webp)
        </div>
...
```
  ...
  {/* REST - BigLake */}
  <TabItem value="biglake" label="BigLake">
  ...
  :::note BigLake Catalog Supported for v0.9.0 and above
  ...
  **Required permissions**:
  - **Service Account Roles**:
    - `BigLake Editor` (`roles/biglake.editor`) – for writing table data.
    - `Storage Object User` (`roles/storage.objectUser`) – on all associated Cloud Storage buckets.

  For detailed setup instructions, prerequisites, and IAM configuration, refer to the [Google Cloud BigLake REST Catalog documentation](https://docs.cloud.google.com/lakehouse/docs/set-up-lakehouse-iceberg-rest-catalog).
  ...
  <TabItem value="biglake-ui" label="OLake UI" default>
  <br/>
      ...
      **BigLake Configuration Parameters:**
      | Parameter        | Sample Value                               | Description                                                                                     |
      |------------------|--------------------------------------------|-------------------------------------------------------------------------------------------------|
      | **REST Catalog URI** <br/> `required` | `https://biglake.googleapis.com/iceberg/v1/restcatalog` | Endpoint URL for the Google Cloud BigLake REST catalog service. |
      | **BigLake Catalog Path** <br/> `required` | **Single-bucket catalog:**<br/>`gs://<BUCKET_NAME>` <br/><br/>**Multiple-bucket catalog:**<br/>`bl://projects/<PROJECT_ID>/catalogs/<CATALOG_ID>`| BigLake catalog path to use, OLake Go uses this to look up the storage configuration (e.g. Cloud Storage buckets) already defined in BigLake.<br/><br/>**Single-bucket catalog:** This configuration restricts your catalog to a single bucket and locks the catalog name to the bucket name. Use bucket root path only, subfolder paths such as `gs://<BUCKET_NAME>/<subfolder>` is not supported yet.<br/><br/>**Multiple-bucket catalog:** This configuration lets your catalog associate multiple buckets and lets you name your catalog independently of any bucket name. |
      | **Authentication Type** <br/> `required` | `GCP` | Iceberg authentication manager for Google Cloud OAuth. BigLake supports only this auth type. |
      | **GCP Service Account JSON** <br/> `required` | `{ "type": "service_account", ... }` | JSON content of the GCP service account key file. OLake Go uses this to authorize REST catalog and Cloud Storage access in your Google Cloud project. |
      | **Catalog Name**  | `olake_iceberg`                  | Name of the Iceberg catalog OLake Go registers tables under. Defaults to `olake_iceberg` if left empty.                                           |
  ...
  <TabItem value="biglake-cli" label="OLake CLI">
...
```
    ...
    **BigLake Configuration Parameters**
      ...
      | **gcp_service_account_json** <br/> `required`| `{"type": "service_account", ...}` | JSON content of the GCP service account key file. OLake Go uses this to authorize REST catalog and Cloud Storage access in your Google Cloud project.                                                |
      | **catalog_name**  | `olake_iceberg`                  | Name of the Iceberg catalog OLake Go registers tables under. Defaults to `olake_iceberg` if left empty.                                            |
  ...
  <TabItem value="horizon" label="Horizon">
    ...
    OLake Go supports [Snowflake Horizon Catalog](https://docs.snowflake.com/en/user-guide/tables-iceberg-access-using-external-query-engine-snowflake-horizon) as an Iceberg REST catalog destination. Configure External OAuth, key-pair authentication, programmatic access tokens (PAT), or workload identity federation (WIF/OIDC) to authenticate OLake Go to the Horizon REST endpoint.
    
     ## Important Limitations

    - **Positional Deletes Only**: Snowflake does not support equality deletes when querying Iceberg tables.
    - **Managed Storage Only**: Iceberg REST writes are supported only for Snowflake Managed Storage.

    ## Prerequisites

    - **Database**: A Snowflake database where OLake Go will create Iceberg tables. The database must have its catalog and external volume configured as SNOWFLAKE and SNOWFLAKE_MANAGED respectively:
      ```sql
      ALTER DATABASE <your_database_name> SET CATALOG = 'SNOWFLAKE';
      ALTER DATABASE <your_database_name> SET EXTERNAL_VOLUME = 'SNOWFLAKE_MANAGED';
      ```
    - **Role**: A Snowflake role with database usage privileges and permission to create schemas, assigned to the user OLake Go will use for authentication.
    - **Authentication Policy**: An authentication policy that allows your chosen authentication method, attached to the user.
    - **Account identifier**: Your Snowflake account identifier uses the form `<org>-<account>`. Look it up with:

      ```sql
      SELECT CURRENT_ORGANIZATION_NAME() || '-' || CURRENT_ACCOUNT_NAME() AS account_identifier;
      ```
    - **Region**: The region of your Snowflake account. Look it up with:
    ...
    Configure the following fields to connect OLake Go to your Horizon REST catalog.

    ### Authentication

    The catalog supports multiple authentication types. Select the one your service uses to see the fields you need to configure.

    <Tabs queryString="rest-auth-type" groupId="horizon-rest-auth">
      <TabItem value="programmatic-access-token-pat" label="Programmatic Access Token (PAT)" default>

        To use **Programmatic Access Token (PAT)** authentication with Horizon Catalog, generate a PAT in Snowflake first. Follow the steps in the [Using programmatic access tokens for authentication](https://docs.snowflake.com/en/user-guide/programmatic-access-tokens) documentation to create and securely store the token before configuring OLake Go.

        <Tabs queryString="tab">

        <TabItem value="horizon-ui" label="OLake UI" default>
        <br/>

        <div className='flex justify-center w-2/3 mx-auto'>
        ![REST endpoint config form with required fields for Horizon Iceberg database connection.](/img/docs/iceberg/catalog/rest/pat_horizon.webp)
        </div>

        <HorizonIcebergWriterUIConfigDetails authType="programmatic-access-token-pat" />

        Click **`Create ->`** to test the connection and verify that OLake Go can validate both the Horizon Catalog REST endpoint and authentication.

        </TabItem>

        <TabItem value="horizon-cli" label="OLake CLI">
        ...
        ```json title="destination.json"
        {
          ...
          "writer": {
            ...
            "rest_catalog_url": "https://<account_identifier>.snowflakecomputing.com/polaris/api/catalog",
            "iceberg_s3_path": "SNOW",
            "aws_region": "AWS_AP_SOUTH_1",
            "scope": "session:role:HORIZON_ROLE",
            "rest_auth_type": "Programmatic Access Token (PAT)",
        ...
        <HorizonIcebergWriterCLIConfigDetails authType="programmatic-access-token-pat" />
      ...
      <TabItem value="key-pair-authentication" label="Key-Pair Authentication">

        To use **Key-Pair Authentication** with Horizon Catalog, generate an RSA key pair and assign the public key to your Snowflake user, then produce the JWT that OLake Go uses as the Iceberg credential. Follow the steps in the [Key-pair authentication and key-pair rotation](https://docs.snowflake.com/en/user-guide/key-pair-auth) documentation.
        ...
        <div className='flex justify-center w-2/3 mx-auto'>
        ![REST endpoint config form with required fields for Horizon Iceberg database connection.](/img/docs/iceberg/catalog/rest/key_pair_horizon.webp)
        </div>

        <HorizonIcebergWriterUIConfigDetails authType="key-pair-authentication" />
        ...
        ```json title="destination.json"
        {
          ...
          "writer": {
            ...
            "aws_region": "AWS_AP_SOUTH_1",
            "scope": "session:role:HORIZON_ROLE",
            "rest_auth_type": "Key-Pair Authentication",
            "credential": "<KEY_PAIR_JWT>",
            "oauth2_uri": "https://<account_identifier>.snowflakecomputing.com/polaris/api/catalog/v1/oauth/tokens",
            "arrow_writes": false
          }
        }
        ```

        <HorizonIcebergWriterCLIConfigDetails authType="key-pair-authentication" />
      ...
      <TabItem value="external-oauth" label="External OAuth">

        To use **External OAuth** with Horizon Catalog, configure an External OAuth security integration in Snowflake and obtain a bearer access token for OLake Go. Follow the steps in the [External OAuth overview](https://docs.snowflake.com/en/user-guide/oauth-ext-overview) documentation.
        ...
        <div className='flex justify-center w-2/3 mx-auto'>
        ![REST endpoint config form with required fields for Horizon Iceberg database connection.](/img/docs/iceberg/catalog/rest/external_oauth_horizon.webp)
        </div>

        <HorizonIcebergWriterUIConfigDetails authType="external-oauth" />
        ...
        <HorizonIcebergWriterCLIConfigDetails authType="external-oauth" />
      ...
      <TabItem value="workload-identity-federation-wif-oidc" label="Workload Identity Federation(WIF)/OIDC">

        To use **Workload Identity Federation(WIF)/OIDC** with Horizon Catalog, configure workload identity federation in Snowflake and obtain a short-lived OIDC token from your cloud identity provider. Follow the steps in the [Workload identity federation](https://docs.snowflake.com/en/user-guide/workload-identity-federation) documentation.
        ...
        <div className='flex justify-center w-2/3 mx-auto'>
        ![REST endpoint config form with required fields for Horizon Iceberg database connection.](/img/docs/iceberg/catalog/rest/oidc_horizon.webp)
        </div>

        <HorizonIcebergWriterUIConfigDetails authType="workload-identity-federation-wif-oidc" />
        ...
        ```json title="destination.json"
        {
          ...
          "writer": {
            ...
            "aws_region": "AWS_AP_SOUTH_1",
            "scope": "session:role:HORIZON_ROLE",
            "rest_auth_type": "Workload Identity Federation(WIF)/OIDC",
        ...
        <HorizonIcebergWriterCLIConfigDetails authType="workload-identity-federation-wif-oidc" />
    ...
    1. **Database or role name mismatch (case sensitivity)**: Snowflake uppercases unquoted identifiers. If `CREATE DATABASE IF NOT EXISTS snow` is run, or a role is created without double quotes, Snowflake stores the name as `SNOW`, not `snow`. If double quotes are used (`CREATE DATABASE IF NOT EXISTS "snow"`), the name is stored exactly as written. OLake Go must use the same spelling and casing as created in Snowflake.
