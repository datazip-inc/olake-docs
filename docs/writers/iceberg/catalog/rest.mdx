...
<Tabs queryString="tab">
  ...
  {/* REST – Unity */}
    ...
    :::info[Enable Metastore External Data Access]
    This step requires **Metastore Administrator** access. If you're not an administrator, contact your admin to enable external data access:
