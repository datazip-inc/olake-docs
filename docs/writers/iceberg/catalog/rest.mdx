...
### Configuration
  <Tabs>
    ...
    ![Create Destination](/img/docs/iceberg/catalog/rest/rest-generic-ui-config.png)
...
![Nessie UI Configuration](/img/docs/iceberg/catalog/rest/rest-generic-ui-config.png)
