      ...
      <Tabs queryString="tab">
        <TabItem value="rest-ui" label="OLake UI" default>
          ...
          **Lakekeeper Configuration Parameters:**
          ...
          | **S3 Endpoint**      | `http://<S3_ENDPOINT>:9000` | S3 API endpoint for reading/writing Iceberg data files. Leave empty for AWS S3 but required for S3-compatible storage like MinIO.               |
          ...
          | **REST Auth URI**           | `https://auth.server.com/oauth/token` | URL of the REST catalog’s authentication endpoint. OLake uses this when token-based authentication is configured.                                                                   |
    ...
    **Required permissions**:
    ...
    <Tabs queryString="tab">
      ...
      Before setting up the destination, ensure the [source](/docs/getting-started/creating-first-pipeline#3-configure-source) has been successfully configured.   
        ...
        | **S3 Path**  | `<POLARIS_CATALOG_NAME>`                                  | Name of the Polaris catalog.                                        |
