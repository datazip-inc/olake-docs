  ...
  **Required permissions**:
  ...
  <br/>
      ...
      **BigLake Configuration Parameters:**
      ...
      | **S3 Path** <br/> `required` | **Single-bucket catalog:**<br/>`gs://<BUCKET_NAME>` | BigLake catalog path to use, OLake Go uses this to look up the storage configuration (e.g. Cloud Storage buckets) already defined in BigLake.<br/><br/>**Single-bucket catalog:** This configuration restricts your catalog to a single bucket and locks the catalog name to the bucket name. |
...
```
    ...
    **BigLake Configuration Parameters**
      ...
      | **iceberg_s3_path**  <br/> `required`| **Single-bucket catalog:**<br/>`gs://<BUCKET_NAME>`<br/> | BigLake catalog path to use, OLake Go uses this to look up the storage configuration (e.g. Cloud Storage buckets) already defined in BigLake.<br/><br/>**Single-bucket catalog:** Use the format `gs://BUCKET_NAME`. This configuration restricts your catalog to a single bucket and locks the catalog name to the bucket name.                                                |
