  ...
  <Tabs queryString="tab">
    <TabItem value="rest-ui" label="OLake UI" default>
      ...
      <div className='flex justify-center w-2/3 mx-auto'>
        ![REST catalog setup form with required fields for catalog type, URIs, database, S3 path, AWS credentials, and region.](/img/docs/iceberg/catalog/rest/rest_generic.png)
      </div>
      ...
      **Permissions**:
      ...
      <Tabs queryString="tab">
        <TabItem value="rest-ui" label="OLake UI" default>
          ...
          <div className='flex justify-center w-2/3 mx-auto'>
          ![REST endpoint config form with required fields for Iceberg database connection.](/img/docs/iceberg/catalog/rest/rest_lakekeeper.png)
        </div>
    ...
    **Permissions**:
    ...
    <Tabs queryString="tab">
      ...
      <TabItem value="nessie-ui" label="OLake UI" default>
        ...
        <div className='flex justify-center w-2/3 mx-auto'>
          ![REST endpoint config form with required fields for Iceberg database connection.](/img/docs/iceberg/catalog/rest/rest_nessie.png)
        </div>
...
<Tabs queryString="tab">
  ...
  <TabItem value="s3tables-ui" label="OLake UI" default>
      ...
      <div className='flex justify-center w-2/3 mx-auto'>
        ![Iceberg REST config form with required fields for Catalog URI, S3 Path, database, AWS credentials, and region](/img/docs/iceberg/catalog/rest/rest_s3_tables.png)
      </div>
    ...
    **Required permissions**:
    ...
    <Tabs queryString="tab">
      ...
      Before setting up the destination, ensure the [source](/docs/getting-started/creating-first-pipeline#2-configure-source) has been successfully configured.   
        ...
        <div className='flex justify-center w-2/3 mx-auto'>
          ![REST endpoint config form with fields for REST, database, S3, and AWS credentials](/img/docs/iceberg/catalog/rest/rest_polaris.png)
        </div>
