...
import JDBCIcebergWriterUIConfigDetails from '@site/docs/shared/config/JDBCIcebergWriterUIConfigDetails.mdx';
import JDBCIcebergWriterCLIConfigDetails from '@site/docs/shared/config/JDBCIcebergWriterCLIConfigDetails.mdx';

<Tabs queryString="tab" groupId="jdbc-config-type">
...
<JDBCIcebergWriterUIConfigDetails/>
...
<JDBCIcebergWriterCLIConfigDetails/>
