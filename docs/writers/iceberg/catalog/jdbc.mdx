...
- <span style={{ color: '#1a73e8' }}>Connection Refused to Host:Port</span>
...
- <span style={{ color: '#1a73e8' }}>Authentication Failed for User</span>
...
- <span style={{ color: '#1a73e8' }}>Access Denied or Forbidden S3 Error</span>
  - Cause: Invalid S3 credentials or insufficient bucket permissions.
  - Fix:
