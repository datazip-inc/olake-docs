...
![AWS Glue source config section with inputs for catalog type, S3 path, database, AWS credentials, and region](/img/docs/iceberg/catalog/glue/glue_catalog_img.webp)
