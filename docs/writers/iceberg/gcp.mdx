...
Currently OLake Go supports writing data to Google Cloud Storage (GCS), using [`Hive Catalog`](/docs/writers/iceberg/catalog/hive#gcp-dataproc-metastore) that supports Iceberg. This allows you to leverage GCS as a scalable and durable storage solution for your data lakehouse architecture.
