...
:::info
Refer to [spark-defaults.conf](https://github.com/datazip-inc/olake/blob/master/writers/iceberg/local-test/spark-defaults.conf) for more information about the values set for catalog configurations.
