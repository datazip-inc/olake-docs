...
Before proceeding with either configuration, please ensure you have completed the [getting started](../getting-started/quickstart) instructions. For more background details, refer to the [README section](https://github.com/datazip-inc/olake/blob/master/README.md).
...
If you have any further questions or need additional support, please refer to the [getting started](../getting-started/quickstart) section or the [OLake README](https://github.com/datazip-inc/olake/blob/master/README.md).
