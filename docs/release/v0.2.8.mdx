...
1. **Clear destination in Iceberg -** <br/> Introduced a clear destination feature for Iceberg that enables selective stream cleanup. This feature removes all streams that were selected for that particular job. It’s useful when stream configurations like normalization, filters, or partitions have changed and a fresh sync is needed.
