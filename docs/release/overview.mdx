...
- 🎯 What's New: Additions or enhancements introduced in this release across Sources, Destinations, Catalogs, or cross‑cutting Platform features; typically new connectors, capabilities, flags, or behavior that expand OLake’s functionality.
- 🔧 Bug Fixes & Stability: Corrections and hardening to existing functionality in this release; reliability, performance, and compatibility fixes (e.g., retries, state handling, type conversions, dependency updates).
