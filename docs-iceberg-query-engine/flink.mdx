...
<QueryEngineLayout
  ...
  officialDocs="https://nightlies.apache.org/flink/flink-docs-stable/"
  gettingStarted="https://iceberg.apache.org/docs/latest/flink/"
  additionalResources={[
    ...
    { label: "Flink Actions API", url: "https://iceberg.apache.org/docs/latest/flink-maintenance/#rewrite-data-files" },
