...
export const flinkFeatures = [
  {
    ...
    chip: "Full Support",
    description: "[Hive Metastore](/iceberg/query-engine/hive), Hadoop catalog, REST catalog (incl. Nessie), [AWS Glue](/iceberg/query-engine/athena), JDBC, plus any custom implementation via catalog-impl",
