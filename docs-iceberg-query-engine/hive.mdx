...
export const hiveTableData = {
  ...
  rows: [
    ...
    },
    {
      ...
      support: {
        value: <span className="text-green-600 dark:text-green-400 font-semibold">Full</span>,
        badge: { text: "SQL + Properties", variant: "success" }
      },
      details: {
        value: "SQL time travel via FOR SYSTEM_TIME AS OF / FOR SYSTEM_VERSION AS OF (Hive 4.0+); snapshot/branch properties also supported",
        tooltip: "Hive 4.0+ supports SQL time travel clauses in addition to snapshot-based access"
      },
      version: { value: "4.0+" }
    },
    {
    ...
    },
    {
      ...
      details: {
        value: "Early Hive 4 snapshot bugs; requires Tez for DML; no Format V3 support; no REST/Nessie catalog support",
...
<QueryEngineLayout
  ...
  officialDocs="https://cwiki.apache.org/confluence/display/Hive/GettingStarted"
  ...
  additionalResources={[
    ...
    { label: "Apache Ranger Documentation", url: "https://cwiki.apache.org/confluence/display/RANGER/Index" },
    { label: "Hive Performance Tuning", url: "https://cwiki.apache.org/confluence/display/Hive/Configuration+Properties" },
    { label: "Table Migration Guide", url: "https://iceberg.apache.org/docs/latest/hive/#alter-table-migrate-table" }
  ]}
/>
