      ...
      technicalSpecs: [
        {
          ...
          items: [
            { label: "[Hive Metastore](/docs/writers/iceberg/catalog/hive/)", value: "Full Support", status: "available" },
            { label: "[AWS Glue](/docs/writers/iceberg/catalog/glue/)", value: "Full Support", status: "available" },
