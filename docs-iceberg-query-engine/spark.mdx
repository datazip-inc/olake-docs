      ...
      technicalSpecs: [
        {
          ...
          items: [
            { label: "[Hive Metastore](/iceberg/query-engine/hive)", value: "Full Support", status: "available" },
            { label: "[AWS Glue](/iceberg/query-engine/athena)", value: "Full Support", status: "available" },
