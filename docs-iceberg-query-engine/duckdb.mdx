  ...
  {[
    {
      ...
      mainEntity: [
        {
          '@type': 'Question',
          name: 'What level of Apache Iceberg support does DuckDB offer?',
          acceptedAnswer: {
            '@type': 'Answer',
        ...
        {
          '@type': 'Question',
          name: 'What Iceberg features are currently supported and what are the limitations in DuckDB?',
          acceptedAnswer: {
            '@type': 'Answer',
        ...
        {
          '@type': 'Question',
          name: 'How does DuckDB integrate with Iceberg catalogs and storage?',
          acceptedAnswer: {
            '@type': 'Answer',
        ...
        {
          '@type': 'Question',
          name: 'What are common use cases for using DuckDB with Iceberg tables?',
          acceptedAnswer: {
            '@type': 'Answer',
