...
export const clickhouseFeatures = [
  ...
  },
  {
    ...
    chip: "Since 25.4",
    description: "[Time-travel](/blog/apache-polaris-lakehouse) since 25.4 with SET iceberg_timestamp_ms=<epoch> or iceberg_snapshot_id; partition pruning via use_iceberg_partition_pruning=1",
