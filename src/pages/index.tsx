      ...
      <div className='olakehome-page olake-design-page'>
        <div
          ...
          style={{
            ...
            backgroundImage:
              'linear-gradient(rgba(25, 58, 230, 0.025) 1px,transparent 1px),linear-gradient(90deg,rgba(25, 58, 230, 0.025) 1px,transparent 1px)',
          ...
          >
            <div
              style={{
                ...
                width: '760px',
                height: '400px',
                background: 'radial-gradient(ellipse,rgba(25, 58, 230, 0.15),transparent 72%)',
                filter: 'blur(30px)',
              ...
              <div>
                <div
                  style={{
                    ...
                    fontSize: '12px',
                    color: '#193AE6',
                    border: '1px solid rgba(25, 58, 230, 0.3)',
                    background: 'rgba(25, 58, 230, 0.05)',
                    borderRadius: '999px',
                    padding: '7px 15px',
                    marginBottom: '28px'
                  }}
                >
                  <span
                    style={{
                      ...
                      height: '7px',
                      borderRadius: '50%',
                      background: 'rgb(63, 168, 114)',
                      boxShadow: 'rgb(63, 168, 114) 0px 0px 8px'
                    }}
                  />{' '}
                ...
                >
                  ...
                  <br />
                  Keep it <span style={{ color: '#193AE6', position: 'relative' }}>fast.</span>
                </h1>{' '}
                <div
                  style={{
                    fontSize: '20px',
                ...
                >
                  <a
                    ...
                    style={{
                      ...
                      fontSize: '16px',
                      boxShadow:
                        '0 6px 0 #5762da, 0 8px 14px rgba(255, 255, 255, 0.2), inset 0 1px 0 rgba(0, 0, 0, 0.32)',
                  ...
                  <a
                    ...
                    style={{
                      ...
                      boxShadow:
                        '0 6px 0 rgba(0, 0, 0, 0.1), 0 8px 14px rgba(255, 255, 255, 0.16), inset 0 1px 0 rgba(0, 0, 0, 0.12)',
                      transition: 'transform 0.07s ease, box-shadow 0.07s ease'
                    }}
                  >
                    Get in touch
              ...
              >
                ...
                <div
                  style={{
                    ...
                    aspectRatio: '1/1',
                    borderRadius: '50%',
                    background: 'radial-gradient(circle,#d5ddff,#e7ecff)',
                    border: '1px solid rgba(25, 58, 230, 0.4)',
                    boxShadow:
                      '0 0 0 10px rgba(25, 58, 230, 0.08), 0 0 60px -8px rgba(25, 58, 230, 0.6)',
                    display: 'flex',
                    alignItems: 'center',
                ...
                >
                  <img
                    loading='lazy'
                    decoding='async'
                    src='/img/landing/v2/constellation-hub-icon.webp'
                    alt='OLake'
                ...
                >
                  <div
                    style={{
                      ...
                      boxShadow: '0 8px 22px -10px rgba(255, 255, 255, 0.26)',
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center',
                      padding: '16%',
                ...
                >
                  ...
                  >
                    <img
                      loading='lazy'
                      decoding='async'
                      src='/img/landing/v2/connector-kafka.webp'
                      alt='Kafka'
                      style={{ width: '100%', height: '100%', objectFit: 'contain' }}
                    />
                  </div>{' '}
                ...
                >
                  ...
                  >
                    <img
                      loading='lazy'
                      decoding='async'
                      src='/img/landing/v2/connector-mongodb.webp'
                      alt='MongoDB'
                      style={{ width: '100%', height: '100%', objectFit: 'contain' }}
                    />
                  </div>{' '}
                ...
                >
                  ...
                  >
                    <img
                      loading='lazy'
                      decoding='async'
                      src='/img/landing/v2/connector-oracle.webp'
                      alt='Oracle'
                      style={{ width: '100%', height: '100%', objectFit: 'contain' }}
                    />
                  </div>{' '}
                ...
                >
                  ...
                  >
                    <img
                      loading='lazy'
                      decoding='async'
                      src='/img/landing/v2/connector-mysql.webp'
                      alt='MySQL'
                      style={{ width: '100%', height: '100%', objectFit: 'contain' }}
                    />
                  </div>{' '}
                ...
                >
                  ...
                  >
                    <img
                      loading='lazy'
                      decoding='async'
                      src='/img/landing/v2/connector-s3.webp'
                      alt='S3'
                      style={{ width: '100%', height: '100%', objectFit: 'contain' }}
                    />
                  </div>{' '}
                ...
                >
                  ...
                  >
                    <img
                      loading='lazy'
                      decoding='async'
                      src='/img/landing/v2/connector-mssql.webp'
                      alt='MSSQL'
                      style={{ width: '100%', height: '100%', objectFit: 'contain' }}
                    />
                  </div>{' '}
                ...
                >
                  ...
                  >
                    <img
                      loading='lazy'
                      decoding='async'
                      src='/img/landing/v2/connector-postgres.webp'
                      alt='Postgres'
                      style={{ width: '100%', height: '100%', objectFit: 'contain' }}
                    />
                  </div>{' '}
                ...
                <React.Fragment key={engIdx}>
                  <a
                    ...
                    style={{
                      ...
                      background: 'linear-gradient(160deg, #4862EB, #193AE6)',
                      ...
                      color: 'inherit',
                      boxShadow:
                        '0 22px 48px -24px rgba(25, 58, 230, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.22)',
                  ...
                  >
                    <div
                      style={{
                        ...
                        right: '0',
                        height: '44%',
                        borderRadius: '24px 24px 60% 60%/24px 24px 22px 22px',
                                ...
                                <>
                                  <span
                                    style={{
                                      ...
                                      borderRadius: '999px',
                                      whiteSpace: 'nowrap',
                                      boxShadow: '0 2px 6px rgba(20,37,122,0.5)'
                                    }}
                                  >
                                    COMING SOON
                                  </span>
          ...
          <div style={{ maxWidth: '1360px', margin: '0 auto', padding: '124px 48px' }}>
              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    fontSize: '12px',
                    fontWeight: '500',
                    background: `${fusionTabBg}`,
                    color: `${fusionTabColor}`
                  }}
                >
                  Fusion
                </div>
            ...
            <div
              style={{
                ...
                borderRadius: '22px',
                padding: '48px 52px',
                backgroundImage: `${advantageBg}`,
                backgroundRepeat: 'no-repeat, no-repeat',
                backgroundPosition: `${advantagePos}`,
            ...
            >
              <div
                style={{
                  ...
                  right: '0',
                  height: '44%',
                  borderRadius: '22px 22px 60% 60%/22px 22px 20px 20px',
                  background: 'linear-gradient(180deg,rgba(255, 255, 255, 0.16),transparent)',
                  pointerEvents: 'none'
                }}
              />{' '}
                ...
                {(advantageStats || []).map((stat, statIdx) => (
                  <React.Fragment key={statIdx}>
                    <div style={{ flex: '1' }}>
                      ...
                      <div style={{ fontSize: '18px', color: '#FFFFFF', marginTop: '18px' }}>
                        {stat.label}
                      </div>
                    </div>
                  </React.Fragment>
                  ...
                  >
                    ...
                    >
                      <defs>
                        ...
                        >
                          <path d='M0 0 L9 4.5 L0 9 Z' fill='#6E7CFF' />
                        </marker>
                      </defs>{' '}
                      <g
                        fill='none'
                    ...
                    >
                      ...
                      <div style={{ fontWeight: '700', fontSize: '26px', color: '#ffffff' }}>
                        OLake Go
                      </div>{' '}
                      <div style={{ fontSize: '16px', color: '#FFFFFF', marginTop: '3px' }}>
                        Ingestion engine
                      </div>{' '}
                      <div
                        style={{
                    ...
                    <div
                      style={{
                        ...
                        border: '1px solid rgba(16,24,64,0.1)',
                        borderRadius: '18px',
                        boxShadow: '0 16px 40px -26px rgba(16,24,64,0.18)',
                        display: 'flex',
                        alignItems: 'center',
                        gap: '16px',
                        padding: '0 24px',
                        ...
                        >
                          ...
                          <span
                            style={{
                              ...
                              padding: '3px 7px',
                              whiteSpace: 'nowrap',
                              boxShadow: '0 3px 8px -2px rgba(20,37,122,0.6)'
                            }}
                          >
                            COMING SOON
                          </span>
                  ...
                  >
                    <div
                      style={{
                        ...
                        borderRadius: '18px',
                        background: 'linear-gradient(160deg,#e7ecff,#f2f5ff)',
                        boxShadow: '0 -24px 60px -20px rgba(255, 255, 255, 0.85)',
                        overflow: 'hidden'
                      }}
                    >
                      <div
                        style={{
                          ...
                          background: 'linear-gradient(160deg, #4862EB, #193AE6)',
                          borderBottom: '1px solid rgba(212, 215, 228, 0.12)'
                        }}
                      >
                        <div
                          style={{
            ...
            <div style={{ maxWidth: '1360px', margin: '0 auto', padding: '0 48px 132px' }}>
              ...
              >
                <div style={{ flex: '1', minWidth: '300px' }}>
                  ...
                  >
                    {' '}
                    In OLake, they <span style={{ color: 'rgb(25, 58, 230)' }}>trust.</span>
                  </div>
                </div>{' '}
                <div
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '24px' }}>
                <a
                  ...
                  style={{
                    ...
                    boxShadow: '0 24px 50px -26px rgba(0,0,0,0.5)'
                  }}
                >
                  <img
                    loading='lazy'
                    decoding='async'
                    src='/img/landing/v2/story-xeno.svg'
                  ...
                  <div
                    style={{
                      ...
                      inset: '0',
                      background:
                        'linear-gradient(180deg, rgba(8,11,26,0.05) 0%, rgba(8,11,26,0.35) 42%, rgba(8,11,26,0.92) 100%)',
                      pointerEvents: 'none'
                    }}
                  />{' '}
                  <div
                ...
                >
                  <img
                    loading='lazy'
                    decoding='async'
                    src='/img/landing/v2/story-cordial.svg'
                ...
                >
                  <img
                    loading='lazy'
                    decoding='async'
                    src='/img/landing/v2/story-bitespeed.svg'
            ...
            >
              <div
                style={{
                  ...
                  borderRadius: '24px',
                  padding: '72px 56px',
                  background: 'linear-gradient(180deg,#191d29,#262b3b)',
                  overflow: 'hidden'
                }}
              >
                ...
                <div
                  style={{
                    ...
                    inset: '0',
                    background:
                      'linear-gradient(90deg, rgba(25, 29, 41, 0.94), rgba(25, 29, 41, 0.6) 60%, rgba(25, 29, 41, 0.3))',
                    pointerEvents: 'none'
                  }}
                />{' '}
                <div
                  style={{
                    ...
                    inset: '0',
                    backgroundImage:
                      'linear-gradient(rgba(25, 58, 230, 0.08) 1px,transparent 1px),linear-gradient(90deg,rgba(25, 58, 230, 0.08) 1px,transparent 1px)',
                    backgroundSize: '44px 44px',
                    WebkitMaskImage:
                      'radial-gradient(ellipse 60% 100% at 100% 50%,#ffffff,transparent)',
                    maskImage: 'radial-gradient(ellipse 60% 100% at 100% 50%,#ffffff,transparent)',
                    background:
                      'url("/img/landing/v2/enterprise-cta-bg.webp") center / cover no-repeat',
                    overflow: 'visible',
                    top: '-1px'
                  }}
                />{' '}
                ...
                >
                  <div style={{ maxWidth: '620px' }}>
                    ...
                    >
                      Built for the way your team runs data.
                    </div>{' '}
                    <div style={{ fontSize: '18px', lineHeight: '1.65', color: '#FFFFFF' }}>
                      Custom pricing and packages for enterprises based on your requirements. Leave
                      your contact information and our team will get in touch.
                    </div>
                  </div>{' '}
                  <a
                    className='olakehome-h3'
                  ...
                  >
                    <div
                      style={{
                        ...
                        boxShadow: '0 24px 48px -14px rgba(0,0,0,0.4)',
                    ...
                    >
                      ...
                      <img
                        loading='lazy'
                        decoding='async'
                        src='/img/landing/shared/olake-logo.svg'
                        alt='OLake'
                        style={{
                          height: '20px',
                          width: 'auto',
