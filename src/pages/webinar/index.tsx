        ...
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
          ...
          <section className="mb-20">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                Join our regular community meetups to stay updated with the latest OLake developments, 
                share experiences, and connect with fellow data engineers
              </p>
            </div>
