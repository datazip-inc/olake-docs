...
const WebinarPage = () => {
  const webinarData = {
    ...
    image_url: '/img/webinars/w-8-distributed-stream-processing-in-practice-cover.jpg',
    event_url: 'https://olake.io/webinar/w-8-distributed-stream-processing-in-practice',
  };
