...
const SimpleBenchmarkCard: React.FC<{
  ...
  return (
    ...
    >
      {/* Card Title */}
      <h3 className='mb-4 pb-1 pt-2 font-space text-base font-bold leading-[23.02px] text-[#333333] dark:text-white'>
        {title}
      </h3>
      ...
      <div className='mb-3 flex items-center justify-between rounded-lg bg-[#E6F4E0] px-3 py-2 dark:bg-green-900/20'>
        <div className='flex items-baseline gap-1'>
          <span className='font-space text-[12px] font-medium leading-none text-[#333333] dark:text-white'>
            {TOOLS.olake.name}
          </span>
        ...
        <span className='font-space text-[10px] font-bold leading-6 tracking-[0.02em] text-[#389E0D] dark:text-green-400'>
          {rowData.olake}
        </span>
      </div>
            ...
            <div key={tool.key} className='flex items-center justify-between px-3 py-2'>
              <div className='flex items-center gap-2'>
                <img
                  ...
                  loading='lazy'
                />
                <span className='font-space text-[10px] font-medium leading-none text-[#333333] dark:text-gray-300'>
                  {TOOLS[tool.key].name}
                </span>
              </div>
              <span className='font-space text-[10px] font-medium leading-none text-[#333333] dark:text-gray-300'>
