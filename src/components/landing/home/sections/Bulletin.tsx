...
export default function Bulletin({ latestReleaseLabel, latestReleasePath }: BulletinProps) {
  ...
  return (
    <section className='bg-[#141414] px-[32px] py-[48px] text-[#e7e7e0] lg:px-[24px] lg:py-[72px]'>
      <div className='mx-auto w-full max-w-[1016px]'>
        {latestReleaseLabel && (
          <div className='flex flex-col gap-[6px] rounded-[12px] bg-[#1c1c1c] px-[18px] py-[14px] lg:flex-row lg:items-center lg:gap-[18px] lg:px-[24px]'>
        ...
        <p className='mt-[32px] text-[13px] text-[#8a8a8a] lg:mt-[48px] lg:text-[14px]'>
          Latest News
        </p>
