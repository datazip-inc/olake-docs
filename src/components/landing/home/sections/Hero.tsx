  ...
  return (
    <section className='relative px-[32px] pb-[64px] pt-[180px] lg:px-[24px] lg:pb-[150px] lg:pt-[190px]'>
      <div className='mx-auto w-full max-w-[1016px] lg:text-center'>
        <h1 className='text-[length:clamp(24px,7.4vw,28px)] font-normal leading-[1.28] text-[#202020] lg:mx-auto lg:max-w-[820px] lg:text-[46px] lg:leading-[1.24] lg:tracking-[-0.01em]'>
          {HERO.headline}
          <span className='block text-[#7a7a7a] lg:inline'>{HERO.headlineTail}</span>
        </h1>
