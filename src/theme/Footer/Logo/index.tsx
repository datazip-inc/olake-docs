    ...
    <>
      <div className={styles.logoContainer}>
        ...
        <div className={styles.socialIcons}>
          ...
          <a href="https://join.slack.com/t/getolake/shared_invite/zt-420z5tl04-1EOq5JK0Z4kpiAFoVQXIDQ" className={styles.socialIcon} target="_blank"  rel="noopener noreferrer">
