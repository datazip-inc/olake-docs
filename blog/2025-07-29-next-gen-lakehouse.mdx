...
jsonLd: |
  {
    ...
    "@type": "TechArticle",
    "headline": "Building Modern Lakehouse with Iceberg, OLake, Lakekeeper & Trino",
    "alternativeHeadline": "Complete guide to building next-generation data lakehouse architecture with Apache Iceberg, OLake, Lakekeeper, and Trino for governed analytics",
    "author": {
      "@type": "Person",
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://olake.io/blog/building-modern-data-lakehouse-with-olake-iceberg-lakekeeper-trino"
    },
    "description": "Iceberg is the storage \"brain,\" OLake is the real-time \"pipeline,\" and Trino is the fast \"question-answering\" engine. Together they turn raw object-storage files into a governed, low-latency analytics platform.",
    "keywords": "data lakehouse, apache iceberg, olake, lakekeeper, trino, modern architecture, governed analytics, real-time pipeline, storage brain, query engine, analytics platform, data governance, low-latency, object storage, data engineering",
    ...
    "about": [
      {
        ...
        "description": "Next-generation data architecture combining lake and warehouse capabilities"
      },
      {
        "@type": "Thing",
        "name": "Data Governance",
        "description": "Framework for managing data quality, security, and compliance in analytics platforms"
      },
      {
        "@type": "Thing",
        "name": "Real-Time Pipeline",
        "description": "Data processing pipeline that handles streaming data in real-time"
      },
      {
        "@type": "Thing",
        "name": "Analytics Platform",
        "description": "Comprehensive platform for data analysis and business intelligence"
      }
    ],
    "mentions": [
      {
    ...
    "mainEntity": {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What is the role of each component in the modern lakehouse architecture?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Apache Iceberg serves as the storage brain providing ACID transactions and schema evolution, OLake acts as the real-time pipeline for data replication, Lakekeeper provides data governance and cataloging, and Trino serves as the fast query engine for analytics."
          }
        },
        {
          "@type": "Question",
          "name": "How does this architecture enable governed analytics?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The architecture enables governed analytics through Lakekeeper's data catalog and governance features, Iceberg's ACID transactions and schema evolution, OLake's reliable data replication, and Trino's consistent query interface across all data sources."
          }
        },
        {
          "@type": "Question",
          "name": "What are the benefits of using Trino in a lakehouse?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Trino provides fast SQL querying across multiple data sources, supports federated queries, offers excellent performance for analytical workloads, integrates seamlessly with Apache Iceberg, and provides a consistent interface for data access across the lakehouse."
          }
        },
        {
          "@type": "Question",
          "name": "How does Lakekeeper enhance data governance?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Lakekeeper provides centralized data cataloging, metadata management, data lineage tracking, access control, and governance policies that ensure data quality, security, and compliance across the entire lakehouse architecture."
          }
        }
      ]
    }
