...
<Faq showHeading={false} data={[
  {
    ...
    answer: <div>
      <p>Every write to an Iceberg table whether from CDC, Kafka streaming, or batch jobs creates new Parquet data files. Over time, this can result in thousands or even millions of small files.</p>
