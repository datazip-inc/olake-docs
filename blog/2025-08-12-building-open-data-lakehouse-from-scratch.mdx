...
jsonLd: |
  {
    ...
    "@type": "TechArticle",
    "headline": "Building a Complete Open Data Lakehouse from Scratch with OLake, PrestoDB and MinIO",
    "alternativeHeadline": "Step-by-step guide to building a complete open data lakehouse architecture using MySQL, OLake, PrestoDB and MinIO for real-time CDC and analytics",
    "author": {
      "@type": "Person",
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://olake.io/blog/building-open-data-lakehouse-with-olake-presto"
    },
    "description": "Learn how to build a complete open data lakehouse from scratch using MySQL, OLake, PrestoDB and MinIO. Get it running on your local machine in just a few steps with real-time CDC and analytics.",
    "keywords": "data lakehouse, olake, prestodb, minio, mysql, apache iceberg, real-time, cdc, analytics, open source, architecture, tutorial, guide, setup, configuration, data engineering, etl, elt, data replication, streaming",
    ...
    "about": [
      ...
      },
      {
        ...
        "description": "System architecture built using open-source components and technologies"
      },
      {
        "@type": "Thing",
      ...
      },
      {
        ...
        "description": "End-to-end data processing architecture from source to analytics"
      }
    ],
    "mentions": [
      {
      ...
      },
      {
        "@type": "SoftwareApplication",
        "name": "MinIO",
        "applicationCategory": "Object Storage"
      },
      {
        "@type": "SoftwareApplication",
        "name": "MySQL",
    ...
    "mainEntity": {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What components are needed to build an open data lakehouse?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "To build an open data lakehouse, you need a source database (MySQL), data replication tool (OLake), object storage (MinIO), table format (Apache Iceberg), and query engine (PrestoDB). This creates a complete architecture for real-time CDC and analytics."
          }
        },
        {
          "@type": "Question",
          "name": "How does OLake fit into the data lakehouse architecture?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "OLake serves as the data replication pipeline that captures changes from MySQL source database and streams them to Apache Iceberg tables stored in MinIO object storage, enabling real-time CDC for the lakehouse architecture."
          }
        },
        {
          "@type": "Question",
          "name": "What are the benefits of using PrestoDB in a lakehouse?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "PrestoDB provides fast SQL querying capabilities across the data lakehouse, supports multiple data sources, offers excellent performance for analytical workloads, and integrates seamlessly with Apache Iceberg and MinIO for comprehensive analytics."
          }
        },
        {
          "@type": "Question",
          "name": "Why choose MinIO for object storage in a lakehouse?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "MinIO provides S3-compatible object storage that's easy to deploy locally, offers high performance, supports distributed deployments, and integrates well with Apache Iceberg and other lakehouse components for scalable data storage."
          }
        }
      ]
    },
    "tutorial": {
      "@type": "HowTo",
      "name": "How to Build a Complete Open Data Lakehouse from Scratch",
      "step": [
        {
          "@type": "HowToStep",
          "name": "Set Up MySQL Source",
          "text": "Configure MySQL database as the source for your data lakehouse"
        },
        {
          "@type": "HowToStep",
          "name": "Deploy MinIO Storage",
          "text": "Set up MinIO object storage for scalable data lake storage"
        },
        {
          "@type": "HowToStep",
          "name": "Configure OLake Pipeline",
          "text": "Set up OLake to replicate data from MySQL to Apache Iceberg tables in MinIO"
        },
        {
          "@type": "HowToStep",
          "name": "Deploy PrestoDB",
          "text": "Configure PrestoDB query engine for analytics on the lakehouse data"
        },
        {
          "@type": "HowToStep",
          "name": "Test Analytics",
          "text": "Run analytical queries to validate the complete lakehouse architecture"
        }
      ]
    }
  }
