...
jsonLd: |
  {
    ...
    "@type": "TechArticle",
    "headline": "What makes OLake fast?",
    "alternativeHeadline": "Deep dive into OLake's performance optimization techniques including adaptive chunking strategies and parallelized execution for high-throughput ELT workloads",
    "author": [
      {
        "@type": "Person",
        "name": "Vaibhav Verma",
        "jobTitle": "OLake Maintainer",
        "image": "https://olake.io/img/authors/vaibhav.jpg",
        "email": "hello@olake.io",
        "sameAs": "https://linkedin.com/in/vaibhav-verma-iiitr"
      },
      {
        "@type": "Person",
        "name": "Vikash Choudhary",
        "jobTitle": "OLake Maintainer",
        "image": "https://olake.io/img/authors/vikash.jpg",
        "email": "hello@olake.io",
        "sameAs": "https://linkedin.com/in/vikash-choudhary-939299226"
      }
    ],
    "publisher": {
      "@type": "Organization",
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://olake.io/blog/what-makes-olake-fast"
    },
    "description": "OLake is engineered for high-throughput ELT workloads, leveraging a combination of adaptive chunking strategies & parallelized execution for historical load, and change data capture (CDC) techniques to optimize data ingestion performance.",
    "keywords": "olake, performance, optimization, chunking strategies, parallelized execution, high-throughput, elt, etl, data ingestion, mongodb, mysql, postgresql, adaptive chunking, split vector, bucket auto, timestamp strategy, ctid ranges, data processing, scalability, throughput",
    ...
    "about": [
      {
        "@type": "Thing",
        "name": "Data Chunking",
        "description": "Strategy for dividing large datasets into manageable fragments for parallel processing"
      },
      {
        "@type": "Thing",
        "name": "Parallel Processing",
        "description": "Execution of multiple tasks simultaneously to improve performance"
      },
      {
        "@type": "Thing",
        "name": "Data Ingestion",
        "description": "Process of importing data into a database or data warehouse"
      },
      {
        "@type": "Thing",
        "name": "Performance Optimization",
        "description": "Techniques to improve system performance and throughput"
      }
    ],
    "mentions": [
      {
    ...
    "mainEntity": {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What chunking strategies does OLake support?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "OLake supports multiple chunking strategies: Split Vector Strategy (uses MongoDB's splitVector command), Bucket Auto Strategy (employs $bucketAuto aggregation), Timestamp Strategy (leverages ObjectId timestamps), CTID Ranges (for PostgreSQL), Split via Batch Size, and Split via Next Query for different database engines."
          }
        },
        {
          "@type": "Question",
          "name": "How does OLake optimize performance for different databases?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "OLake uses database-specific chunking strategies. For MongoDB, it uses splitVector or bucketAuto. For MySQL, it chunks based on primary key ranges. For PostgreSQL, it uses CTID ranges or split columns. Each strategy is optimized for the database's data distribution patterns and indexing structures."
          }
        },
        {
          "@type": "Question",
          "name": "What is the purpose of parallel chunking in OLake?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Parallel chunking maximizes parallelism and throughput for full/historical loads by splitting tables into manageable fragments that can be processed independently by dedicated worker threads, enabling concurrent extraction and transformation."
          }
        },
        {
          "@type": "Question",
          "name": "How does OLake handle configurable concurrency?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The maximum number of concurrent threads is configurable via the source.json file, enabling users to fine-tune parallelism based on workload sensitivity and infrastructure capacity to prevent overwhelming the source database."
          }
        }
      ]
    }
