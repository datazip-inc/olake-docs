...
### Q1. What chunking strategies does OLake use to maximize parallel data extraction speed?
...
### Q2. How does OLake's Split Vector strategy work for MongoDB parallel loading?
...
### Q3. What is the Bucket Auto chunking strategy in OLake and when is it used?
...
2. **When `_id` fields are non-ObjectID types:** collections with UUID, integer, or string `_id` fields are incompatible with Split Vector and should use Bucket Auto instead
...
### Q4. How does OLake's parallel execution model prevent overwhelming the source database?
...
### Q5. What makes OLake's CDC sync more efficient than batch replication for ongoing data pipelines?
