...
Ready to leverage Apache Iceberg for your data lakehouse? [OLake](https://github.com/datazip-inc/olake) provides seamless CDC replication from operational databases directly to Iceberg tables, helping you build a modern lakehouse architecture with support for structured, semi-structured, and spatial data. Check out the [GitHub repository](https://github.com/datazip-inc/olake) and join the [Slack community](https://join.slack.com/t/getolake/shared_invite/zt-420z5tl04-1EOq5JK0Z4kpiAFoVQXIDQ) to get started.
