...
jsonLd: |
  {
    ...
    "@type": "TechArticle",
    "headline": "MongoDB CDC using Debezium and Kafka",
    "alternativeHeadline": "Complete guide to real-time MongoDB data replication with Debezium and Apache Kafka for data warehouse integration",
    "author": {
      "@type": "Person",
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://olake.io/blog/mongodb-cdc-using-debezium-and-kafka"
    },
    "description": "If you're into the world of data replication or streaming and wondering how to move your MongoDB data into a data warehouse or lakehouse, this article might shed some light into in's and out's of considering Debezium.",
    "keywords": "mongodb, debezium, kafka, cdc, change data capture, data replication, real-time, streaming, data warehouse, lakehouse, etl, elt, data engineering, analytics, performance, tutorial, guide, setup, configuration, deployment, monitoring, observability, oplog, change streams, cursor, snapshot, incremental sync",
      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, Debezium uses Kafka Connect. Debezium operates as a Kafka Connect connector. Kafka Connect is a framework that simplifies the integration of Apache Kafka with other data systems like databases, key-value stores, and more."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, Kafka and Kafka Connect are different components, but they work together. Apache Kafka is a powerful distributed streaming platform that handles publishing and subscribing to streams of records, while Kafka Connect is a framework for connecting Kafka with other data systems."
          }
        },
        {
          "@type": "Question",
          "name": "How does Debezium capture changes from MongoDB?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Debezium captures changes from MongoDB using the oplog (operation log) or change streams. It connects to the MongoDB replica set's oplog, uses a cursor to track position, reads new entries in real-time, transforms them to structured events, and publishes them to specific Kafka topics."
          }
        },
        {
          "@type": "Question",
          "name": "What are the advantages of using Debezium with Kafka?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Advantages include decoupled systems allowing independent scaling, flexible integrations to multiple downstream systems, ease of use with Kafka Connect framework, pre-built connectors for popular databases, and simplified integration reducing custom code requirements."
          }
        }
      ]
    },
    "tutorial": {
      "@type": "HowTo",
      "name": "How to Set Up MongoDB CDC with Debezium and Kafka",
      "step": [
        {
          "@type": "HowToStep",
          "name": "Set Up Kafka Cluster",
          "text": "Install and configure a Kafka cluster with at least three brokers for fault tolerance"
        },
        {
          "@type": "HowToStep",
          "name": "Configure Zookeeper",
          "text": "Set up Zookeeper for cluster coordination as Kafka relies on it"
        },
        {
          "@type": "HowToStep",
          "name": "Deploy Kafka Connect",
          "text": "Install Kafka Connect to run Debezium connectors"
        },
        {
          "@type": "HowToStep",
          "name": "Configure Debezium Connector",
          "text": "Set up Debezium to capture changes from MongoDB by writing detailed JSON configuration file"
        },
        {
          "@type": "HowToStep",
          "name": "Set Up Sink Connector",
          "text": "Configure sink connector to move data from Kafka into your data lake or warehouse"
        }
      ]
    }
  }
