...
<Faq showHeading={false} data={[
  {
    ...
    answer: <div>
      ...
      <ul>
        ...
        <li><strong>Row-based:</strong> Records exact row-level before and after values for every changed row</li>
      ...
      <p><strong>Important:</strong> <code>binlog_format</code> is deprecated as of MySQL 8.0.34 and is subject to removal in a future version. Row-based logging is now the default and the only recommended format for new MySQL replication and CDC setups.</p>
  ...
  },
  {
    ...
    answer: <div>
      <ul>
        ...
        <li><strong>Row-based logging:</strong> Records the exact before and after values for every changed row. Safer and more storage-intensive, but ensures perfect consistency. This is the safest format and the only one recommended for new replication setups.</li>
