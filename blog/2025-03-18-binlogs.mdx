...
### Q1. What are MySQL binary logs (binlogs) and what do they record?
...
### Q2. How do MySQL binlogs enable Change Data Capture (CDC) for data pipelines?
...
### Q3. What is the difference between statement-based, row-based, and mixed binlog format?
...
### Q4. How can MySQL binlogs be used for point-in-time database recovery?
...
### Q5. What binlog retention settings should I configure for CDC pipelines?
...
- Set to at least **604800 seconds (7 days)** — this is the consistent recommendation across CDC tool documentation and Percona's operational guidelines.
