...
<Faq showHeading={false} data={[
  ...
  },
  {
    ...
    answer: <div>
      ...
      <p>Alternatively, <a href="https://olake.io/docs/fusion">OLake Fusion</a> monitors table health continuously and triggers compaction automatically, so you don't have to run this diagnosis by hand.</p>
    </div>
  },
  {
