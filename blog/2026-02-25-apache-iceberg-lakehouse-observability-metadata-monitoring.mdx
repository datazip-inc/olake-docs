...
<Faq showHeading={false} data={[
  {
    question: "What are Apache Iceberg metadata tables?",
    answer: <div>
  ...
  {
    question: "How do you find the small files problem in an Iceberg table?",
    answer: <div>
  ...
  {
    question: "How do you detect schema changes in Apache Iceberg?",
    answer: <div>
  ...
  {
    question: "How do you measure storage bloat from Iceberg snapshots?",
    answer: <div>
      <p>Compare the <code>files</code> table (active data) against <code>all_data_files</code> (data referenced across all tracked snapshots) and take the ratio of their total sizes. If total storage is much larger than active storage, for example 5x or more, retained snapshots and time-travel history are consuming significant extra storage.</p>
  ...
  {
    question: "What is the difference between pull-based and push-based Iceberg monitoring?",
    answer: <div>
