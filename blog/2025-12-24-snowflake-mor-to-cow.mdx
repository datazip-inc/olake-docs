...
- Access to your Iceberg catalog (configured in Spark)
- Access to the S3 bucket where your Iceberg tables are stored
- Appropriate AWS credentials or IAM roles configured
