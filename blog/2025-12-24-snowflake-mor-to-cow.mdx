...
<Faq showHeading={false} data={[
  {
    question: "Q1. Why can't Databricks query OLake's Iceberg tables directly without conversion?",
    answer: <div>
      ...
      <p>Because OLake uses equality deletes for efficient CDC ingestion, a conversion step is often required to ensure compatibility with engines that expect fully materialized data.</p>
    </div>
  },
  {
