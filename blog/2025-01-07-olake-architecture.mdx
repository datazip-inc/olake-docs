...
jsonLd: |
  {
    ...
    "@type": "TechArticle",
    "headline": "OLake Architecture, How did we do it?",
    "alternativeHeadline": "Deep dive into OLake's architecture for fastest database to data lakehouse data pipeline with performance benchmarks",
    "author": {
      "@type": "Person",
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://olake.io/blog/olake-architecture"
    },
    "description": "When building OLake, our goal was simple: Fastest DB to Data LakeHouse (Apache Iceberg to start) data pipeline. This article walks through the architecture of OLake and how it captures data from MongoDB and pushes it into S3 in Apache Iceberg format.",
    "keywords": "olake, apache iceberg, data lakehouse, etl, elt, mongodb, data engineering, analytics, performance, cdc, change data capture, architecture, data pipeline, real-time, streaming, parquet, s3, open source, data replication, schema evolution, monitoring, alerting",
    ...
    "about": [
      ...
      },
      {
        "@type": "Thing",
        "name": "Data Pipeline",
        "description": "Set of data processing elements connected in series for data transformation"
      },
      {
        "@type": "Thing",
    ...
    "mainEntity": {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What is OLake's main goal?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "OLake's main goal is to be the fastest database to data lakehouse data pipeline, specifically targeting Apache Iceberg format with high performance and minimal overhead."
          }
        },
        {
          "@type": "Question",
          "name": "What are OLake's main components?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "OLake consists of CLI, Framework (CDK), Connectors (Drivers), Writers, Testing Setup, Monitoring & Alerting, and SDK. These components work together to provide a modular and efficient data replication solution."
          }
        },
        {
          "@type": "Question",
          "name": "How does OLake handle performance?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "OLake uses parallel chunking, native BSON extraction, integrated destinations, and CDC cursor preservation to achieve high performance. It completed a 230 million row full load in 46 minutes and handles 35,694 records/second in incremental sync."
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "OLake stores data in open formats like Parquet using Apache Iceberg table format, enabling various query engines including Spark, Trino, Flink, or Snowflake external tables for maximum flexibility."
          }
        }
      ]
    }
