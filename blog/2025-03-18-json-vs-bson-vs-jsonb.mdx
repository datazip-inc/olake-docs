...
#### Why BSON Exists
As [MongoDB](/docs/connectors/mongodb) began to rise in popularity as a NoSQL document store, the need for a more efficient, flexible format than plain JSON became apparent. BSON was developed to:
