...
jsonLd: |
  {
    ...
    "@type": "TechArticle",
    "headline": "Deploying OLake on Kubernetes with Helm",
    "alternativeHeadline": "Deploy a complete, production-ready OLake data replication platform on Kubernetes in minutes using the official Helm chart",
    "author": {
      "@type": "Person",
      "name": "Schitiz",
      "jobTitle": "OLake Team",
      ...
      "sameAs": "https://linkedin.com/in/schitiz"
    },
    "publisher": {
      "@type": "Organization",
      "name": "OLake",
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://olake.io/blog/deploying-olake-on-kubernetes-helm"
    },
    "description": "Deploy a complete, production-ready OLake data replication platform on Kubernetes in minutes using the official Helm chart. Covers architecture, quickstart, and production guidance.",
    "keywords": "kubernetes, helm, olake, deployment, data replication, cdc, data lakehouse, apache iceberg, parquet, production, scalable, observable, secure, container orchestration",
    ...
    "about": [
      {
        ...
        "description": "Process of deploying applications on Kubernetes container orchestration platform"
      },
      {
        "@type": "Thing",
        "name": "Helm Charts",
        "description": "Package manager for Kubernetes applications providing templating and deployment capabilities"
      },
      {
        "@type": "Thing",
        "name": "Data Replication Platform",
        "description": "System for copying and synchronizing data between different data sources and destinations"
      },
      {
        "@type": "Thing",
        "name": "Production Deployment",
        "description": "Process of deploying applications in production environments with proper monitoring and security"
      }
    ],
    "mentions": [
      {
      ...
      },
      {
        "@type": "SoftwareApplication",
        "name": "Helm",
        "applicationCategory": "Kubernetes Package Manager"
      },
      {
        "@type": "SoftwareApplication",
        "name": "OLake",
    ...
    "mainEntity": {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What is the OLake Helm chart?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The OLake Helm chart is an official package that allows you to deploy a complete, production-ready OLake data replication platform on Kubernetes with a single command. It includes all necessary components for scalable, observable, and secure data pipelines."
          }
        },
        {
          "@type": "Question",
          "name": "How do you deploy OLake on Kubernetes?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Deploy OLake on Kubernetes using the official Helm chart by adding the OLake repository, configuring your values file with source and destination settings, and running helm install. The chart handles all component deployment and configuration automatically."
          }
        },
        {
          "@type": "Question",
          "name": "What are the benefits of using Kubernetes for OLake?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Benefits include automatic scaling based on workload, built-in high availability and fault tolerance, resource management and optimization, easy rolling updates, comprehensive monitoring and observability, and production-ready security features."
          }
        },
        {
          "@type": "Question",
          "name": "What data formats does OLake support?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "OLake supports Apache Iceberg and Parquet formats for data lakehouse storage. It can replicate data from various source databases like PostgreSQL, MySQL, and MongoDB to these open table formats in your data lake."
          }
        }
      ]
    },
    "tutorial": {
      "@type": "HowTo",
      "name": "How to Deploy OLake on Kubernetes with Helm",
      "step": [
        {
          "@type": "HowToStep",
          "name": "Add Helm Repository",
          "text": "Add the official OLake Helm repository to your Kubernetes cluster"
        },
        {
          "@type": "HowToStep",
          "name": "Configure Values",
          "text": "Create a values.yaml file with your source and destination database configurations"
        },
        {
          "@type": "HowToStep",
          "name": "Deploy with Helm",
          "text": "Run helm install command to deploy OLake components on your Kubernetes cluster"
        },
        {
          "@type": "HowToStep",
          "name": "Verify Deployment",
          "text": "Check that all pods are running and OLake is successfully connected to your data sources"
        },
        {
          "@type": "HowToStep",
          "name": "Monitor Data Pipeline",
          "text": "Set up monitoring and observability to track data replication performance and health"
        }
      ]
    }
  }
