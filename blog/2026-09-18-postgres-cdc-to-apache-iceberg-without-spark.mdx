...
![PostgreSQL source configuration in the OLake UI](/img/blog/2026/18/postgres_to_iceberg_source_config.webp)
...
![Apache Iceberg destination configuration in the OLake UI](/img/blog/2026/18/postgres_to_iceberg_destination_config.webp)
...
![Creating an OLake job with PostgreSQL source and Iceberg destination](/img/blog/2026/18/postgres_to_iceberg_job_setup.webp)
...
![OLake sync running and job history for the PostgreSQL to Iceberg pipeline](/img/blog/2026/18/postgres_to_iceberg_sync_ref.webp)
