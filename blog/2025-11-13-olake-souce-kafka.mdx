...
<Faq showHeading={false} data={[
  ...
  },
  {
    ...
    answer: <div>
      <p>OLake commits to the Iceberg destination first — writing and committing Parquet data files and Iceberg metadata — and only then commits Kafka consumer group offsets. This ordering means that:</p>
      <ul>
