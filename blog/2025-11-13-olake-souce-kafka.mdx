...
<Faq showHeading={false} data={[
  ...
  },
  {
    ...
    answer: <div>
      <p>OLake commits to the Iceberg destination first, writing and committing the Parquet data files and Iceberg metadata, and only then commits the Kafka consumer group offsets. This ordering means that:</p>
      <ul>
  ...
  },
  {
    ...
    answer: <div>
      ...
      <p>For SASL-based protocols, OLake supports the following mechanisms:</p>
      <ul>
