...
jsonLd: |
  {
    ...
    "@type": "TechArticle",
    "headline": "How to Set Up PostgreSQL CDC on AWS RDS - A Step-by-Step Guide",
    "alternativeHeadline": "Complete step-by-step guide to setting up PostgreSQL Change Data Capture on AWS RDS with practical tips and best practices",
    "author": {
      "@type": "Person",
      "name": "Shubham Satish Baldava",
      "jobTitle": "OLake Maintainer",
      "image": "https://olake.io/img/authors/shubham.jpg",
      "email": "hello@olake.io",
      "sameAs": "https://linkedin.com/in/shubham-baldava"
    },
    "publisher": {
      "@type": "Organization",
      "name": "OLake",
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://olake.io/blog/how-to-set-up-postgresql-cdc-on-aws-rds"
    },
    "description": "We have observed a large number of people not setting up their databases with CDC or having to set up CDC after they start ingesting and finding it complex. This comprehensive guide walks through setting up PostgreSQL CDC on AWS RDS.",
    "keywords": "postgresql, cdc, change data capture, aws rds, wal, write-ahead logs, logical replication, real-time, data replication, tutorial, guide, setup, configuration, data engineering, etl, elt, streaming, database, aws, cloud",
    ...
    "about": [
      {
        ...
        "description": "A method of tracking and analyzing database changes in real-time"
      },
      {
        "@type": "Thing",
        "name": "PostgreSQL",
      ...
      },
      {
        ...
        "description": "Processing and analyzing data as it arrives for immediate insights"
      }
    ],
    "mentions": [
      {
    ...
    "mainEntity": {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What is PostgreSQL CDC and why is it important?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "PostgreSQL CDC (Change Data Capture) is a method to track and record changes made to data in real-time. It enables high-throughput data ELT without putting query pressure on the database and implements real-time data replication with updates, inserts, and deletes."
          }
        },
        {
          "@type": "Question",
          "name": "What are Write-Ahead Logs (WAL) in PostgreSQL?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Write-Ahead Logs (WAL) in PostgreSQL are append-only logs that record all changes made to the database. CDC is usually stored in these WAL logs through a mechanism called Logical Replication, which enables real-time data streaming."
          }
        },
        {
          "@type": "Question",
          "name": "How do you set up CDC on AWS RDS PostgreSQL?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Setting up CDC on AWS RDS PostgreSQL involves enabling logical replication, configuring WAL settings, creating replication slots, setting up proper permissions, and configuring the CDC tool to connect to the RDS instance with the appropriate parameters."
          }
        },
        {
          "@type": "Question",
          "name": "What are the common challenges with PostgreSQL CDC setup?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Common challenges include complex initial setup, managing WAL log retention, handling replication slot management, ensuring proper permissions and security, monitoring CDC performance, and troubleshooting connectivity issues between CDC tools and RDS instances."
          }
        }
      ]
    },
    "tutorial": {
      "@type": "HowTo",
      "name": "How to Set Up PostgreSQL CDC on AWS RDS",
      "step": [
        {
          "@type": "HowToStep",
          "name": "Enable Logical Replication",
          "text": "Configure PostgreSQL parameters to enable logical replication on AWS RDS"
        },
        {
          "@type": "HowToStep",
          "name": "Configure WAL Settings",
          "text": "Set up Write-Ahead Log parameters for CDC functionality"
        },
        {
          "@type": "HowToStep",
          "name": "Create Replication Slot",
          "text": "Create a replication slot for tracking CDC changes"
        },
        {
          "@type": "HowToStep",
          "name": "Set Up Permissions",
          "text": "Configure proper database permissions for CDC operations"
        },
        {
          "@type": "HowToStep",
          "name": "Configure CDC Tool",
          "text": "Set up your CDC tool to connect to the RDS PostgreSQL instance"
        }
      ]
    }
  }
