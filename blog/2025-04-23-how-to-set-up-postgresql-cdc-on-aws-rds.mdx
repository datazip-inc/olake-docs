...
* High-throuput data ELT without putting query pressure on DB. 
 ...
 * Turning on the logical replication (If its not already on), requires a DB instance restart. 
...
- Any new table additions is also taken care automatically.
