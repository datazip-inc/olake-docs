...
### Q1. What is Apache Doris and why use it for Iceberg lakehouse analytics?
...
### Q2. How does OLake sync PostgreSQL data to Apache Iceberg for Doris to query?
...
### Q3. What makes this Postgres-to-Iceberg-to-Doris architecture cost-effective?
...
2. **Independent scaling:** compute (Doris) and storage (S3/MinIO) scale independently based on actual workload demands
3. **Simplified infrastructure:** OLake eliminates the need for complex Kafka and Spark pipeline infrastructure, significantly reducing both infrastructure costs and operational overhead

### Q4. What CDC operations does OLake capture for PostgreSQL to Iceberg replication?
...
### Q5. Does Apache Doris support querying Iceberg tables with equality delete files created by OLake?
