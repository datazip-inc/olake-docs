...
jsonLd: |
  {
    ...
    "@type": "TechArticle",
    "headline": "How to Set Up PostgreSQL to Apache Iceberg Replication for Real-Time Analytics: Complete Guide",
    "alternativeHeadline": "Comprehensive tutorial for setting up real-time PostgreSQL to Apache Iceberg CDC replication with best practices and step-by-step implementation",
    "author": {
      "@type": "Person",
      ...
      "sameAs": "https://linkedin.com/in/rohan-khameshra"
    },
    "publisher": {
      "@type": "Organization",
      "name": "OLake",
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://olake.io/blog/how-to-set-up-postgres-apache-iceberg"
    },
    "description": "Ever wanted to run high-performance analytics on your PostgreSQL data without overloading your production database or breaking your budget? PostgreSQL to Apache Iceberg replication is quickly becoming the go-to solution for modern data teams.",
    "keywords": "postgresql, postgres, apache iceberg, data replication, analytics, lakehouse, performance, real-time, cdc, change data capture, data engineering, etl, elt, olake, tutorial, guide, setup, configuration, wal, write-ahead log, replication slot, streaming",
    ...
    "about": [
      {
        "@type": "Thing",
        "name": "Data Lakehouse",
        "description": "A data architecture that combines the benefits of data lakes and data warehouses"
      },
      {
        "@type": "Thing",
        "name": "Real-Time Analytics",
        "description": "Processing and analyzing data as it arrives to provide immediate insights"
      },
      {
        "@type": "Thing",
    ...
    "mainEntity": {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Why replicate PostgreSQL data to Apache Iceberg?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "PostgreSQL to Iceberg replication enables scalable real-time analytics without overloading your production database, provides cost-effective storage and compute separation, supports ACID transactions, schema evolution, and time travel queries, while maintaining compatibility with modern analytics tools."
          }
        },
        {
          "@type": "Question",
          "name": "What are the key benefits of PostgreSQL to Iceberg replication?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Benefits include scalable real-time analytics without production impact, cost-effective analytics with separation of storage and compute, ACID transactions and schema evolution support, time travel queries for data versioning, and compatibility with multiple query engines like Spark, Trino, and DuckDB."
          }
        },
        {
          "@type": "Question",
          "name": "How does OLake handle PostgreSQL CDC replication?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "OLake uses PostgreSQL's Write-Ahead Log (WAL) and replication slots for real-time change data capture, providing efficient streaming replication with minimal impact on source database performance and ensuring reliable data consistency."
          }
        },
        {
          "@type": "Question",
          "name": "What are the prerequisites for PostgreSQL to Iceberg replication?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Prerequisites include enabling WAL logging and replication slots in PostgreSQL, configuring proper permissions for replication, setting up Apache Iceberg destination with catalog and storage, and ensuring network connectivity between source and destination systems."
          }
        }
      ]
    },
    "tutorial": {
      "@type": "HowTo",
      "name": "How to Set Up PostgreSQL to Apache Iceberg Replication",
      "step": [
        {
          "@type": "HowToStep",
          "name": "Configure PostgreSQL",
          "text": "Enable WAL logging and replication slots in PostgreSQL configuration"
        },
        {
          "@type": "HowToStep",
          "name": "Set Up Iceberg Destination",
          "text": "Configure Apache Iceberg destination with proper catalog and storage settings"
        },
        {
          "@type": "HowToStep",
          "name": "Configure OLake",
          "text": "Set up OLake source and destination configurations for PostgreSQL and Iceberg"
        },
        {
          "@type": "HowToStep",
          "name": "Run Initial Sync",
          "text": "Execute initial full snapshot to populate Iceberg tables"
        },
        {
          "@type": "HowToStep",
          "name": "Enable CDC",
          "text": "Start real-time change data capture using PostgreSQL WAL for ongoing replication"
        }
      ]
    }
  }
