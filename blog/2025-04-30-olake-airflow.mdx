...
jsonLd: |
  {
    ...
    "@type": "TechArticle",
    "headline": "Running OLake on Kubernetes with Your Existing Airflow, Sync Your Data Effortlessly",
    "alternativeHeadline": "Complete guide to orchestrating OLake data synchronization tasks with Apache Airflow on Kubernetes for automated data pipelines",
    "author": {
      "@type": "Person",
      "name": "Schitiz Sharma",
      "jobTitle": "OLake Maintainer",
      "image": "https://olake.io/img/authors/schitiz.jpg",
      "email": "hello@olake.io",
      "sameAs": "https://linkedin.com/in/schitizsharma"
    },
    "publisher": {
      "@type": "Organization",
      "name": "OLake",
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://olake.io/blog/olake-airflow"
    },
    "description": "At OLake, we're building tools to make data integration seamless. Today, we're excited to show you how to leverage your existing Apache Airflow setup to automate OLake data synchronization tasks directly on your Kubernetes cluster!",
    "keywords": "olake, apache airflow, kubernetes, data integration, orchestration, dag, data synchronization, automation, data pipeline, workflow, cron job, scheduling, configmaps, persistent volume, storage class, data engineering, devops, container orchestration",
    ...
    "about": [
      {
        ...
        "description": "Automated management and coordination of data workflows and pipelines"
      },
      {
        "@type": "Thing",
      ...
      },
      {
        ...
        "description": "Process of maintaining data consistency across different systems"
      },
      {
        "@type": "Thing",
        "name": "Workflow Automation",
        "description": "Automated execution of business processes and data pipelines"
      }
    ],
    "mentions": [
      {
      ...
      },
      {
        "@type": "SoftwareApplication",
        "name": "Apache Airflow",
        "applicationCategory": "Workflow Orchestration Platform"
      },
      {
        "@type": "SoftwareApplication",
        "name": "Kubernetes",
    ...
    "mainEntity": {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "What are the prerequisites for running OLake with Airflow on Kubernetes?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "You need a running Apache Airflow instance with LocalExecutor or SequentialExecutor, access to a Kubernetes cluster, Apache Airflow Kubernetes Provider installed, basic familiarity with Airflow concepts (UI, DAGs, Connections) and Kubernetes concepts (Namespaces, ConfigMaps, StorageClasses, PersistentVolumeClaims)."
          }
        },
        {
          "@type": "Question",
          "name": "What Kubernetes resources are required for OLake Airflow integration?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Required resources include three ConfigMaps (olake-source-config, olake-destination-config, olake-streams-config), a PersistentVolumeClaim for state file persistence, a StorageClass that supports ReadWriteMany (RWX) access mode, and proper namespace configuration."
          }
        },
        {
          "@type": "Question",
          "name": "How do you configure the OLake Airflow DAG?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Configure the DAG by setting KUBERNETES_CONN_ID to your Airflow Kubernetes connection, TARGET_NAMESPACE for the Kubernetes namespace, OLAKE_IMAGE to the specific OLake Docker image for your source database, STORAGE_CLASS_NAME to an available ReadWriteMany StorageClass, and optional node affinity settings."
          }
        },
        {
          "@type": "Question",
          "name": "How do you set up OLake cron job scheduling?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Modify the schedule parameter in the DAG definition (line #52) from schedule=None to your desired frequency like '@daily', '@hourly', or custom cron expressions. Refer to Apache Airflow's Cron & Time Intervals documentation for more scheduling options."
          }
        }
      ]
    },
    "tutorial": {
      "@type": "HowTo",
      "name": "How to Set Up OLake with Airflow on Kubernetes",
      "step": [
        {
          "@type": "HowToStep",
          "name": "Install Prerequisites",
          "text": "Install Apache Airflow Kubernetes Provider and ensure you have a running Airflow instance with LocalExecutor or SequentialExecutor"
        },
        {
          "@type": "HowToStep",
          "name": "Configure Kubernetes Connection",
          "text": "Set up an Airflow Connection of type Kubernetes using your kubeconfig file"
        },
        {
          "@type": "HowToStep",
          "name": "Create ConfigMaps",
          "text": "Create three ConfigMaps (olake-source-config, olake-destination-config, olake-streams-config) in your target namespace"
        },
        {
          "@type": "HowToStep",
          "name": "Configure DAG",
          "text": "Download and customize the olake_sync_from_source.py DAG file with your specific configuration values"
        },
        {
          "@type": "HowToStep",
          "name": "Deploy and Run",
          "text": "Place the DAG file in your Airflow dags folder and trigger a manual run to test the setup"
        }
      ]
    }
  }
