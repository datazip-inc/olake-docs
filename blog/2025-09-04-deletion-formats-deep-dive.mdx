...
### Q1. What are position deletes and equality deletes in Apache Iceberg v2?
...
### Q2. What is the difference between Merge-on-Read and Copy-on-Write deletion strategies?
...
|---|---|---|
| Write cost | High (full file rewrite) | Low (small delete file) |
| Read cost | Low (no delete files) | Slightly higher (merge at query time) |
| Best for | Read-heavy, infrequent updates | Write-heavy, frequent CDC updates |

### Q3. How do deletion vectors in Apache Iceberg v3 improve on v2 delete methods?
...
### Q4. How does Delta Lake handle row-level deletions compared to Apache Iceberg?
...
### Q5. When should I choose Copy-on-Write over Merge-on-Read for Iceberg tables?
