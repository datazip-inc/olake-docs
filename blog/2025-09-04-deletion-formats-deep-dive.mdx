...
<Faq showHeading={false} data={[
  ...
  },
  {
    ...
    answer: <div>
      ...
      <p>For most CDC pipelines (OLake, Debezium, Flink CDC), MOR is the correct default, the write volume makes COW impractical, and query engines like Trino handle the merge overhead efficiently.</p>
    </div>
  }
]} />
