...
Now, let's start the **Apache Polaris Catalog** service on the EC2 instance. A detailed doc to start the Polaris Catalog can be found in our [official doc](/docs/writers/iceberg/catalog/rest?rest-catalog=polaris).
