...
### Q1. How do OLake's ingestion filters reduce data pipeline costs and processing time?
...
### Q2.  What SQL-style filter syntax does OLake support?
...
### Q3. How are OLake filters applied differently for SQL databases versus MongoDB?
...
### Q4. Can I combine multiple filter conditions using AND and OR in OLake?
...
### Q5. Does source-level filtering in OLake work during both full refresh and CDC sync modes?
