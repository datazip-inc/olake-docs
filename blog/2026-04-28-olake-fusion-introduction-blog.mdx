...
### Q6. How often should Iceberg tables be compacted?
...
### Q7. Does Iceberg compaction remove delete files?
...
### Q8. How does OLake Fusion differ from running Vanilla Spark's `rewrite_data_files`?
