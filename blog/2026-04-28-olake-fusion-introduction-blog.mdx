...
## Why Spark compaction is hard to operate
...
![Introducing OLake Fusion](/img/blog/2026/5/OLakeFusionBlogCoverImage.webp)
...
the deletes, which is expensive at scale. Position delete files are more efficient: they
record the exact file path and row offset of deleted rows.
