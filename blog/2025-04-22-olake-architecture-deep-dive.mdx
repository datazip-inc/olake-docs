...
<Faq showHeading={false} data={[
  ...
  },
  {
    ...
    answer: <div>
        ...
        <li>CDC is supported for PostgreSQL, MySQL, MongoDB, and MSSQL using each source's native replication mechanism (<code>pgoutput</code>/WAL, binlogs, oplogs, change tables).</li>
