...
### Q1. What is the difference between MySQL and Apache Iceberg?
...
### Q2. How does CDC (Change Data Capture) work with MySQL?
...
### Q3. Can I replicate MySQL to Iceberg without CDC?
...
### Q4. What happens to my MySQL schema changes?
...
### Q5. How much does it cost to store data in Iceberg vs MySQL?
...
### Q6. What query engines can I use with Iceberg tables?
...
### Q7. How do I handle partitioning for optimal query performance?
...
### Q8. Is the initial full load safe for large MySQL databases?
...
### Q9. What happens if my replication pipeline fails?
...
### Q10. Can I query both MySQL and Iceberg simultaneously?
